...
* Implementation status includes `sectionCoverage.expectedIds`, `sectionCoverage.actualIds`, `sectionCoverage.missingIds`, `sectionCoverage.extraIds`, `sectionCoverage.missingRequirementReferenceIds`, and `sectionCoverage.missingExternalBlockerReferenceIds` so C260 chapter and appendix coverage is audited by exact section identity and cannot reference unregistered conformance requirements or external blockers.
