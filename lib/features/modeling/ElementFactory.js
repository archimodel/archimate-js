...
import { toHex, DEFAULT_NOTE_COLOR, BLACK_SHADOW, COLOR_LAYER_MAP } from '../../util/ColorUtil';
  ...
  if (elementType === 'shape') {
    ...
    if (archimateNode) {
      ...
      if (attrs.type === NOTE) {
        ...
        archimateNode = this._archimateFactory.create('archimate:Node', { type: 'Element' });
