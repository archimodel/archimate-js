...
* Implementation status includes `sectionCoverage.expectedIds`, `sectionCoverage.actualIds`, `sectionCoverage.missingIds`, and `sectionCoverage.extraIds` so C260 chapter and appendix coverage is audited by exact section identity.
