...
* `CORE`: extended model-level ArchiMate 4 diagnostics to validate view viewpoint references, view node and connection concept references, viewpoint stakeholder/concern structure, viewpoint definitions, and profile attribute property values.
