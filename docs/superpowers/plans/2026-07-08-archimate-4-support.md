...
view node element references, view connection relationship references, stakeholder/concern structure,
...
`project_memory/runlogs/20260709-1125-status-completion-api-scan.json`; it currently reports 49
