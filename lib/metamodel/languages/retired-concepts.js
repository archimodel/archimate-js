export const ARCHIMATE_3_TO_4_MIGRATIONS = new Map([
  ...
  [ 'Representation', { replacement: 'BusinessObject', originalDomain: 'Business', alternativeReplacements: [ 'DataObject', 'Artifact', 'Material' ], preserveSpecialization: true, warning: 'Representation was retired; migrated to BusinessObject specialization; verify whether DataObject, Artifact, or Material is more precise for this model.' } ],
