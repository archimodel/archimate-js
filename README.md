...
* Implementation status includes `documentArtifactCoverage.expectedIds`, `documentArtifactCoverage.actualIds`, `documentArtifactCoverage.missingDocumentArtifactIds`, and `documentArtifactCoverage.extraDocumentArtifactIds` so the C260 Index outline artifact is audited as a non-implementation reference instead of being mixed into language section coverage.
