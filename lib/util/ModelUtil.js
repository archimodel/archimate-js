...
export const RELATIONSHIP_ELEMENT_MAP = new Map([
  ...
  [CX.RELATIONSHIP_JUNCTION_AND, { className: 'archimate-relation-and-junction', typeName: CX.RELATIONSHIP_JUNCTION_AND, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_JUNCTION_AND, typeRelationship: CX.RELATIONSHIP_TYPE_CONNECTOR }],
  [CX.RELATIONSHIP_JUNCTION_OR, { className: 'archimate-relation-or-junction', typeName: CX.RELATIONSHIP_JUNCTION_OR, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_JUNCTION_OR, typeRelationship: CX.RELATIONSHIP_TYPE_CONNECTOR }],
