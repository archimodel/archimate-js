...
relationship references, viewpoint definitions, stakeholder/concern structure, and profile attribute
property values.
...
- `validateArchimate4Model()` reports unsupported relationship types, unsupported endpoint concept
  ...
  view node element references, invalid view connection relationship references, invalid viewpoint
  definitions, invalid stakeholder/concern structure, and invalid profile attribute properties as
...
- `getArchimate4ImplementationStatus().modelValidation` must expose expected/actual/missing/extra
  ...
  node element-reference, view connection relationship-reference, viewpoint definition,
  stakeholder/concern structure, or profile attribute property coverage.
