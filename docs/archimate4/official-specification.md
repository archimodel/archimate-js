...
view node geometry, junction consistency, view viewpoint references, view node element references, view connection
relationship references, endpoint references, endpoint-to-relationship alignment, and waypoint geometry, viewpoint definitions, model-defined and profile-defined viewpoint
...
- `validateArchimate4Model()` reports unsupported relationship types, unsupported endpoint concept
  ...
  view node element references, invalid view node geometry values, invalid view connection relationship references, invalid endpoint
  references, endpoint-to-relationship alignment mismatches, invalid waypoint geometry values, invalid
...
- `getArchimate4ImplementationStatus().modelValidation` must expose expected/actual/missing/extra
  ...
  view connection endpoint-alignment, view connection waypoint-geometry, viewpoint definition, viewpoint
