 ...
 * @param {ArchimateModdle} moddle
 */
export default function ModdleCopy(eventBus, archimateFactory, moddle) {
...
ModdleCopy.prototype.copyProperty = function(property, parent, propertyName) {
  ...
  if (isObject(property) && property.$type) {
    var desc = this._moddle.getElementDescriptor(property);
    logger.log(desc);
    if (this._moddle.getElementDescriptor(property).isGeneric) {
      return;
    }

    copiedProperty = self._archimateFactory.create(property.$type);
