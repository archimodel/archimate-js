...
import {
  ...
  LAYER_STRATEGY, LAYER_SUB_IMPLEMENTATION, LAYER_SUB_MIGRATION, 
  LAYER_SUB_PHYSICAL, LAYER_TECHNOLOGY,
  ASPECT_BEHAVIOR, ASPECT_ACTIVE
} from '../util/ModelUtil';

export const COLOR_LAYER_STRATEGY = {r: '245', g: '222', b: '170', a: '100'}, // 'rgba(245, 222, 170, 1)'
  COLOR_LAYER_BUSINESS = {r: '255', g: '255', b: '181', a: '100'}, // 'rgba(255, 255, 181, 1)'
  COLOR_LAYER_APPLICATION = {r: '181', g: '255', b: '255', a: '100'}, // 'rgba(181, 255, 255, 1)'
  COLOR_LAYER_TECHNOLOGY = {r: '201', g: '231', b: '183', a: '100'}, // 'rgba(201, 231, 183, 1)'
  COLOR_LAYER_SUB_PHYSICAL = {r: '201', g: '231', b: '183', a: '100'}, // 'rgba(201, 231, 183, 1)'
  COLOR_LAYER_SUB_IMPLEMENTATION = {r: '255', g: '224', b: '224', a: '100'}, // 'rgba(255, 224, 224,1)'
  COLOR_LAYER_SUB_MIGRATION = {r: '224', g: '255', b: '224', a: '100'}, // 'rgba(224, 255, 224 ,1)'
...
export const COLOR_LAYER_MAP = new Map([
  ...
  [LAYER_SUB_PHYSICAL, COLOR_LAYER_SUB_PHYSICAL],
  [LAYER_SUB_IMPLEMENTATION, COLOR_LAYER_SUB_IMPLEMENTATION],
  [LAYER_SUB_MIGRATION, COLOR_LAYER_SUB_MIGRATION],
