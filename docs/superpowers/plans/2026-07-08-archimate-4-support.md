...
view node element references, view connection relationship and endpoint references, model-defined and
...
`project_memory/runlogs/20260710-0043-status-completion-api-scan.json`; it currently reports 49
