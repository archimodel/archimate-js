...
view node element references, view connection relationship references, endpoint references, and
...
`project_memory/runlogs/20260710-0061-status-completion-api-scan.json`; it currently reports 49
