...
function validateViewElements(views, elementIndex, relationshipIndex, profile, diagnostics) {
  views.forEach(function(view) {
    ...
    viewElements.forEach(function(viewElement) {
      ...
      validateViewConnectionEndpointReference(viewElement, viewElementIndex, diagnostics);
    });
  });
}
...
function validateViewConnectionEndpointReference(viewElement, viewElementIndex, diagnostics) {
  validateViewConnectionEndpointRole(viewElement, viewElementIndex, 'source', {
    invalidCode: 'invalid-view-connection-source-reference',
    unknownCode: 'unknown-view-connection-source-reference'
  }, diagnostics);
  validateViewConnectionEndpointRole(viewElement, viewElementIndex, 'target', {
...
function validateViewConnectionEndpointRole(viewElement, viewElementIndex, role, codes, diagnostics) {
  ...
  if (!viewElementIndex.has(referenceId)) {
...
function getModelOrganizations(model) {
  var organizationsNode = model && (model.organizationsNode || model.organizations);
