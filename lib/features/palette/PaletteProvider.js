...
import { APPLICATION_ELEMENT_MAP, BUSINESS_ELEMENT_MAP, getLayerType, getTypeName, STRATEGY_ELEMENT_MAP } from '../../util/ModelUtil';
...
/*
    ...
    'create.business-role': createAction(
      CX.BUSINESS_ROLE, CX.LAYER_BUSINESS, 'ajs-business-role',
      translate(getTypeName(CX.BUSINESS_ROLE)), { }
    ),
