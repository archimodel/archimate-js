...
import * as CX from '../metamodel/Concept.js';
import * as RX from '../metamodel/RelationshipRelationshipMap.js';
import * as BX from '../metamodel/BusinessRelationshipMap.js';
import * as AX from '../metamodel/ApplicationRelationshipMap.js';
import * as TX from '../metamodel/TechnologyRelationshipMap.js';
import * as PX from '../metamodel/PhysicalRelationshipMap.js';
import * as MX from '../metamodel/MotivationRelationshipMap.js';
import * as IX from '../metamodel/ImpMigRelationshipMap.js';
import * as SX from '../metamodel/StrategyRelationshipMap.js';
import * as OX from '../metamodel/OtherRelationshipMap.js';

export const VIEW = 'root',
      NOTE = 'Label',
      NODE_ELEMENT = 'Element',
      CONNECTION_RELATIONSHIP = 'Relationship',
      CONNECTION_LINE = 'Line';

export const RELATIONSHIP_ELEMENT_MAP = new Map([
  [CX.RELATIONSHIP_ACCESS, { className: 'archimate-relation-access', typeName: CX.RELATIONSHIP_ACCESS, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_ACCESS, typeRelationship: CX.RELATIONSHIP_TYPE_DEPENDENCY }],
  [CX.RELATIONSHIP_AGGREGATION, { className: 'archimate-relation-aggregation', typeName: CX.RELATIONSHIP_AGGREGATION, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_AGGREGATION, typeRelationship: CX.RELATIONSHIP_TYPE_STRUCTURAL }],
  [CX.RELATIONSHIP_ASSIGNMENT, { className: 'archimate-relation-assignment', typeName: CX.RELATIONSHIP_ASSIGNMENT, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_ASSIGNMENT, typeRelationship: CX.RELATIONSHIP_TYPE_STRUCTURAL }],
  [CX.RELATIONSHIP_ASSOCIATION, { className: 'archimate-relation-association', typeName: CX.RELATIONSHIP_ASSOCIATION, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_ASSOCIATION, typeRelationship: CX.RELATIONSHIP_TYPE_DEPENDENCY }],
  [CX.RELATIONSHIP_COMPOSITION, { className: 'archimate-relation-composition', typeName: CX.RELATIONSHIP_COMPOSITION, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_COMPOSITION, typeRelationship: CX.RELATIONSHIP_TYPE_STRUCTURAL }],
  [CX.RELATIONSHIP_FLOW, { className: 'archimate-relation-flow', typeName: CX.RELATIONSHIP_FLOW, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_FLOW, typeRelationship: CX.RELATIONSHIP_TYPE_DYNAMIC }],
  [CX.RELATIONSHIP_INFLUENCE, { className: 'archimate-relation-influence', typeName: CX.RELATIONSHIP_INFLUENCE, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_INFLUENCE, typeRelationship: CX.RELATIONSHIP_TYPE_DEPENDENCY }],
  [CX.RELATIONSHIP_JUNCTION_AND, { className: 'archimate-other-and-junction', layer: CX.LAYER_OTHER, aspect: CX.ASPECT_ACTIVE, typeName: 'And Junction', relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_JUNCTION_AND, typeRelationship: CX.RELATIONSHIP_TYPE_CONNECTOR, pictoRef: 'PICTO_JUNCTION_AND' }],
  [CX.RELATIONSHIP_JUNCTION_OR, { className: 'archimate-other-or-junction', layer: CX.LAYER_OTHER, aspect: CX.ASPECT_ACTIVE, typeName: 'Or Junction', relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_JUNCTION_OR, typeRelationship: CX.RELATIONSHIP_TYPE_CONNECTOR, pictoRef: 'PICTO_JUNCTION_OR' }],
  [CX.RELATIONSHIP_REALIZATION, { className: 'archimate-relation-realization', typeName: CX.RELATIONSHIP_REALIZATION, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_REALIZATION, typeRelationship: CX.RELATIONSHIP_TYPE_STRUCTURAL }],
  [CX.RELATIONSHIP_SERVING, { className: 'archimate-relation-serving', typeName: CX.RELATIONSHIP_SERVING, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_SERVING, typeRelationship: CX.RELATIONSHIP_TYPE_DEPENDENCY }],
  [CX.RELATIONSHIP_SPECIALIZATION, { className: 'archimate-relation-specialization', typeName: CX.RELATIONSHIP_SPECIALIZATION, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_SPECIALIZATION, typeRelationship: CX.RELATIONSHIP_TYPE_OTHER }],
  [CX.RELATIONSHIP_TRIGGERING, { className: 'archimate-relation-triggering', typeName: CX.RELATIONSHIP_TRIGGERING, relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_TRIGGERING, typeRelationship: CX.RELATIONSHIP_TYPE_DYNAMIC }],
]);
...
export const OTHER_ELEMENT_MAP = new Map([
  ...
  [CX.OTHER_AND_JUNCTION, { className: 'archimate-other-and-junction', layer: CX.LAYER_OTHER, aspect: CX.ASPECT_ACTIVE, typeName: 'And Junction', relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_JUNCTION_AND, pictoRef: 'PICTO_JUNCTION_AND' }],
  [CX.OTHER_OR_JUNCTION, { className: 'archimate-other-or-junction', layer: CX.LAYER_OTHER, aspect: CX.ASPECT_ACTIVE, typeName: 'Or Junction', relationshipMap: RX.RELATIONSHIPS_ALLOWED_FROM_RELATIONSHIP_JUNCTION_OR, pictoRef: 'PICTO_JUNCTION_OR' }]
]);
...
export function getProfileElementMap(profile) {
  var concepts = profile ?
    (profile.elements || []).concat(profile.connectors || []) :
    [];

  return new Map(concepts.map(function(element) {
...
export function getLayerType(elementType, profile) {
  var element = getProfileElement(elementType, profile);

  return element && (element.layer || element.domain || element.colorGroup);
}

export function getDomainType(elementType, profile) {
  var element = getProfileElement(elementType, profile);

  return element && element.domain;
}

export function getAspectType(elementType, profile) {
  var element = getProfileElement(elementType, profile);

  return element && element.aspect;
}
...
export function getPictoRef(elementType, profile) {
  var element = getProfileElement(elementType, profile);

  return element && element.pictoRef;
}
...
export function getRelationshipType(elementType) {
  return elementType && RELATIONSHIP_ELEMENT_MAP.has(elementType) && RELATIONSHIP_ELEMENT_MAP.get(elementType).typeRelationship;
}
