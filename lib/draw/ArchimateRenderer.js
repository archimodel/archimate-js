...
export default function ArchimateRenderer(
  ...
  function getInfluenceModifier(connection) {
    ...
    if (connection.modifier !== undefined && connection.modifier !== null && connection.modifier !== '') {
      return String(connection.modifier);
    }

    if (connection.typeOption !== undefined && connection.typeOption !== null && connection.typeOption !== '') {
      return String(connection.typeOption);
    }
