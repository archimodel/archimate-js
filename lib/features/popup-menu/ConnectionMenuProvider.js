...
ConnectionMenuProvider.prototype._getExistingRelationships = function(connection) {
  ...
  const groupDirect = {
    ...
    name: 'Direct existing connection'
  },
    groupReverse = {
    id: 'group-reverse-existing',
    name: 'Reverse existing connection'
  };
  ...
  var relationshipsNode = connection.parent.modelRef.relationshipsNode,
    sourceElementRefId = connection.source.businessObject.elementRef.id,
    targetElementRefId = connection.target.businessObject.elementRef.id;
  ...
  if (relationshipsNode) {
    ...
    var directConnections = filterNode(relationships, sourceElementRefId, targetElementRefId, currentRelationshipRef);
    ...
    var reverseConnections = filterNode(relationships, targetElementRefId, sourceElementRefId);
