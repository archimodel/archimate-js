...
multiplicity notation, junction consistency, viewpoint definitions, and profile attribute property
values.
...
`project_memory/runlogs/20260709-1096-status-completion-api-scan.json`; it currently reports 49
