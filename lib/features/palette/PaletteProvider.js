...
PaletteProvider.prototype.getPaletteEntries = function(element) {
  ...
  function createPopupAction(type, value) {
    ...
    return {
      group: value.paletteGroup || value.domain || value.layer,
...
*/
  ...
  if (profile && profile.elements) {
    getPaletteConcepts(profile).forEach(function(value) {
...
function getPaletteConcepts(profile) {
  return (profile.elements || []).concat(profile.connectors || []);
}
