...
const PICTO_MAP = new Map([
  [CX.BUSINESS_ACTOR, 'PICTO_ACTOR'],
  [CX.BUSINESS_INTERFACE, 'PICTO_INTERFACE'],
  [CX.BUSINESS_FUNCTION, 'PICTO_FUNCTION'],
  [CX.BUSINESS_PROCESS, 'PICTO_PROCESS'],
  [CX.BUSINESS_EVENT, 'PICTO_EVENT'],
  [CX.BUSINESS_COLLABORATION, 'PICTO_COLLABORATION'],
  [CX.BUSINESS_SERVICE, 'PICTO_SERVICE'],
  [CX.BUSINESS_INTERACTION, 'PICTO_INTERACTION'],
  [CX.BUSINESS_OBJECT, 'PICTO_OBJECT'],
  [CX.APPLICATION_COMPONENT, 'PICTO_COMPONENT'],
  [CX.APPLICATION_INTERFACE, 'PICTO_INTERFACE'],
  [CX.APPLICATION_FUNCTION, 'PICTO_FUNCTION'],
  [CX.APPLICATION_PROCESS, 'PICTO_PROCESS'],
  [CX.APPLICATION_EVENT, 'PICTO_EVENT'],
  [CX.APPLICATION_COLLABORATION, 'PICTO_COLLABORATION'],
  [CX.APPLICATION_SERVICE, 'PICTO_SERVICE'],
  [CX.APPLICATION_INTERACTION, 'PICTO_INTERACTION'],
  [CX.APPLICATION_DATA_OBJECT, 'PICTO_OBJECT'],
  [CX.TECHNOLOGY_INTERFACE, 'PICTO_INTERFACE'],
  [CX.TECHNOLOGY_FUNCTION, 'PICTO_FUNCTION'],
  [CX.TECHNOLOGY_PROCESS, 'PICTO_PROCESS'],
