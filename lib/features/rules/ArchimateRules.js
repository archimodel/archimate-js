...
function canConnect(source, target, connection) {
  ...
  if (source.businessObject.type === NODE_ELEMENT) { //is(source.businessObject, 'archimate:Node')) {
    if (target.businessObject.type === NODE_ELEMENT) { //is(target.businessObject, 'archimate:Node')) {
    ...
    if (is(target.businessObject, 'archimate:Connection')) { //target.businessObject.type === CONNECTION_RELATIONSHIP) {
