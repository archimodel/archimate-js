export const ARCHIMATE_3_TO_4_MIGRATIONS = new Map([
  ...
  [ 'BusinessInterface', { replacement: 'Interface', preserveSpecialization: true, warning: 'BusinessInterface was merged into Interface with original domain preserved.' } ],
  [ 'ApplicationInterface', { replacement: 'Interface', preserveSpecialization: true, warning: 'ApplicationInterface was merged into Interface with original domain preserved.' } ],
  [ 'TechnologyInterface', { replacement: 'Interface', preserveSpecialization: true, warning: 'TechnologyInterface was merged into Interface with original domain preserved.' } ],
