...
import {
  ...
  ASPECT_BEHAVIOR, ASPECT_ACTIVE, ASPECT_PASSIVE
...
export const COLOR_LAYER_STRATEGY = { r: '245', g: '222', b: '170', a: '100' }, // 'rgba(245, 222, 170, 1)' '#F5DEAA'
      ...
      COLOR_LAYER_TECHNOLOGY = { r: '201', g: '231', b: '183', a: '100' }, // 'rgba(201, 231, 183, 1)' '#C9E7B7'
      COLOR_LAYER_PHYSICAL = { r: '201', g: '231', b: '183', a: '100' }, // 'rgba(201, 231, 183, 1)' '#C9E7B7'
      COLOR_LAYER_IMP_MIG = { r: '255', g: '224', b: '224', a: '100' }, // 'rgba(255, 224, 224,1)' '#FFE0E0'
      COLOR_LAYER_MOTIVATION = { r: '204', g: '204', b: '255', a: '100' }; // 'rgba(204, 204, 255, 1)' '#CCCCFF'
...
export const BORDER_ASPECT_MAP = new Map([
  ...
  [ASPECT_PASSIVE, ACTIVE_BORDER_RADIUS],
  ['Active Structure', ACTIVE_BORDER_RADIUS],
  ['Passive Structure', ACTIVE_BORDER_RADIUS],
  ['Composite', ACTIVE_BORDER_RADIUS],
  ['Motivation', ACTIVE_BORDER_RADIUS]
]);
...
export function getChamferedRectPath(shape, chamfer) {
  var x = shape.x,
      y = shape.y,
      width = shape.width,
      height = shape.height,
      cut = Math.max(0, Math.min(chamfer || 0, width / 4, height / 2));

  var chamferedRectPath = [
    ['M', x + cut, y],
    ['l', width - cut * 2, 0],
    ['l', cut, cut],
    ['l', 0, height - cut * 2],
  ...
  return componentsToPath(chamferedRectPath);
}
