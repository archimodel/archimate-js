...
* `getArchimate4ImplementationStatus()` exposes machine-readable status for implemented, experimental, optional, and external-source-dependent ArchiMate 4 areas.
