...
import { setArchimate4RelationshipProfile } from './metamodel/languages/archimate4-relationships';
...
export default function BaseViewer(options) {
  ...
  this._configureLanguageOptions(options);
...
BaseViewer.prototype._configureLanguageOptions = function(options) {
  if (!options.archimate4RelationshipProfile) {
    return;
  }

  if (normalizeArchimateVersion(options.archimateVersion) !== '4.0') {
    throw new Error('archimate4RelationshipProfile requires archimateVersion: 4.0');
  }

  setArchimate4RelationshipProfile(
    options.archimate4RelationshipProfile,
    options.archimate4RelationshipProfileOptions
  );
};
