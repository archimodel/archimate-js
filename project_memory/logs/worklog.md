...
- Goal: make C260 Chapter 11 Relationships Between Core Domains auditable by exact outline identity rather than leaving it only in broad section coverage.
- Source check: `project_memory/runlogs/20260709-805-c260-outline-current-extract.txt` confirms the Chapter 11 outline includes 11.1 Example.
- Red test: `project_memory/runlogs/20260709-949-c260-core-domain-relationships-coverage-red-test.txt` failed because `relationshipsBetweenCoreDomainsCoverageCatalog` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `relationshipsBetweenCoreDomainsCoverageCatalog` and `relationshipsBetweenCoreDomainsCoverage` for the Chapter 11 Example heading without copying Relationships Between Core Domains prose.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().relationshipsBetweenCoreDomainsCoverage` with expected/actual/missing/extra ids, `missingRelationshipsBetweenCoreDomainsIds`, `extraRelationshipsBetweenCoreDomainsIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the exact Chapter 11 Relationships Between Core Domains outline boundary.
- Focused verification: `project_memory/runlogs/20260709-950-c260-core-domain-relationships-coverage-focused-test.txt` passed for the Relationships Between Core Domains coverage identity test; `project_memory/runlogs/20260709-951-c260-core-domain-relationships-coverage-status.json` shows expectedCount 1, actualCount 1, no missing Relationships Between Core Domains ids, no extra Relationships Between Core Domains ids, and complete true.
- Verification: `npm run test:language` passed with 174 tests in `project_memory/runlogs/20260709-952-c260-core-domain-relationships-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-953-c260-core-domain-relationships-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-954-c260-core-domain-relationships-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-955-c260-core-domain-relationships-coverage-diff-check.txt`; full registry scoped ESLint passed in `project_memory/runlogs/20260709-956-c260-core-domain-relationships-coverage-eslint-registry-full.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-957-c260-core-domain-relationships-coverage-demo-build.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-958-c260-core-domain-relationships-coverage-repo-lint.txt` with 4382 existing errors.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-959-c260-core-domain-relationships-coverage-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-960-c260-core-domain-relationships-coverage-final-diff-check.txt`.
- Audit: `project_memory/audit/reports/20260709-c260-core-domain-relationships-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 127

- Goal: make C260 Chapter 12 Implementation and Migration Domain auditable by exact outline identity rather than only by broad Implementation and Migration element support.
- Source check: `project_memory/runlogs/20260709-805-c260-outline-current-extract.txt` confirms the Chapter 12 outline from 12.1 through 12.4, including Work Package, Deliverable, Plateau, example, summary, and relationships-with-domains headings.
- Red test: `project_memory/runlogs/20260709-962-c260-implementation-migration-domain-coverage-red-test.txt` failed because `implementationAndMigrationDomainCoverageCatalog` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `implementationAndMigrationDomainCoverageCatalog` and `implementationAndMigrationDomainCoverage` for the eight Chapter 12 outline headings without copying Implementation and Migration Domain prose.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().implementationAndMigrationDomainCoverage` with expected/actual/missing/extra ids, `missingImplementationAndMigrationDomainIds`, `extraImplementationAndMigrationDomainIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the exact Chapter 12 Implementation and Migration Domain outline boundary.
- Focused verification: `project_memory/runlogs/20260709-963-c260-implementation-migration-domain-coverage-focused-test.txt` passed for the Implementation and Migration Domain coverage identity test; `project_memory/runlogs/20260709-964-c260-implementation-migration-domain-coverage-status.json` shows expectedCount 8, actualCount 8, no missing Implementation and Migration Domain ids, no extra Implementation and Migration Domain ids, and complete true.
- Verification: `npm run test:language` passed with 175 tests in `project_memory/runlogs/20260709-965-c260-implementation-migration-domain-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-966-c260-implementation-migration-domain-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-967-c260-implementation-migration-domain-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-968-c260-implementation-migration-domain-coverage-diff-check.txt`; full registry scoped ESLint passed in `project_memory/runlogs/20260709-969-c260-implementation-migration-domain-coverage-eslint-registry-full.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-970-c260-implementation-migration-domain-coverage-demo-build.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-971-c260-implementation-migration-domain-coverage-repo-lint.txt` with 4382 existing errors.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-972-c260-implementation-migration-domain-coverage-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-973-c260-implementation-migration-domain-coverage-final-diff-check.txt`.
- Audit: `project_memory/audit/reports/20260709-c260-implementation-migration-domain-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 128

- Goal: make C260 Chapter 13 Stakeholders, Architecture Views, and Viewpoints auditable by exact outline identity rather than only by broad viewpoint mechanism support.
- Source check: `project_memory/runlogs/20260709-805-c260-outline-current-extract.txt` confirms the Chapter 13 outline from 13.1 through 13.5, including Stakeholders and Concerns, Architecture Views and Viewpoints, Viewpoint Mechanism, Defining and Classifying Viewpoints, Creating the View, and Example Viewpoints headings.
- Red test: `project_memory/runlogs/20260709-975-c260-stakeholders-viewpoints-coverage-red-test.txt` failed because `stakeholdersArchitectureViewsViewpointsCoverageCatalog` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `stakeholdersArchitectureViewsViewpointsCoverageCatalog` and `stakeholdersArchitectureViewsViewpointsCoverage` for the seven Chapter 13 outline headings without copying Stakeholders, Architecture Views, and Viewpoints prose.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().stakeholdersArchitectureViewsViewpointsCoverage` with expected/actual/missing/extra ids, `missingStakeholdersArchitectureViewsViewpointsIds`, `extraStakeholdersArchitectureViewsViewpointsIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the exact Chapter 13 Stakeholders, Architecture Views, and Viewpoints outline boundary.
- Focused verification: `project_memory/runlogs/20260709-976-c260-stakeholders-viewpoints-coverage-focused-test.txt` passed for the Stakeholders, Architecture Views, and Viewpoints coverage identity test; `project_memory/runlogs/20260709-977-c260-stakeholders-viewpoints-coverage-status.json` shows expectedCount 7, actualCount 7, no missing Stakeholders, Architecture Views, and Viewpoints ids, no extra Stakeholders, Architecture Views, and Viewpoints ids, and complete true.
- Verification: `npm run test:language` passed with 176 tests in `project_memory/runlogs/20260709-978-c260-stakeholders-viewpoints-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-979-c260-stakeholders-viewpoints-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-980-c260-stakeholders-viewpoints-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-981-c260-stakeholders-viewpoints-coverage-diff-check.txt`; full registry scoped ESLint passed in `project_memory/runlogs/20260709-982-c260-stakeholders-viewpoints-coverage-eslint-registry-full.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-983-c260-stakeholders-viewpoints-coverage-demo-build.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-984-c260-stakeholders-viewpoints-coverage-repo-lint.txt` with 4382 existing errors.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-985-c260-stakeholders-viewpoints-coverage-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-986-c260-stakeholders-viewpoints-coverage-final-diff-check.txt`.
- Audit: `project_memory/audit/reports/20260709-c260-stakeholders-viewpoints-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 129

- Goal: make C260 Chapter 14 Language Customization Mechanisms auditable by exact outline identity rather than leaving language customization only as broad implementation-defined behavior.
- Source check: `project_memory/runlogs/20260709-805-c260-outline-current-extract.txt` confirms the Chapter 14 outline from 14.1 through 14.2.9, including adding attributes and specialization example headings.
- Red test: `project_memory/runlogs/20260709-988-c260-language-customization-mechanisms-coverage-red-test.txt` failed because `languageCustomizationMechanismsCoverageCatalog` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `languageCustomizationMechanismsCoverageCatalog` and `languageCustomizationMechanismsCoverage` for the eleven Chapter 14 outline headings without copying Language Customization Mechanisms prose.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().languageCustomizationMechanismsCoverage` with expected/actual/missing/extra ids, `missingLanguageCustomizationMechanismsIds`, `extraLanguageCustomizationMechanismsIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the exact Chapter 14 Language Customization Mechanisms outline boundary.
- Focused verification: `project_memory/runlogs/20260709-989-c260-language-customization-mechanisms-coverage-focused-test.txt` passed for the Language Customization Mechanisms coverage identity test; `project_memory/runlogs/20260709-990-c260-language-customization-mechanisms-coverage-status.json` shows expectedCount 11, actualCount 11, no missing Language Customization Mechanisms ids, no extra Language Customization Mechanisms ids, and complete true.
- Verification: `npm run test:language` passed with 177 tests in `project_memory/runlogs/20260709-991-c260-language-customization-mechanisms-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-992-c260-language-customization-mechanisms-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-993-c260-language-customization-mechanisms-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-994-c260-language-customization-mechanisms-coverage-diff-check.txt`; full registry scoped ESLint passed in `project_memory/runlogs/20260709-995-c260-language-customization-mechanisms-coverage-eslint-registry-full.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-996-c260-language-customization-mechanisms-coverage-demo-build.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-997-c260-language-customization-mechanisms-coverage-repo-lint.txt` with 4382 existing errors.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-998-c260-language-customization-mechanisms-coverage-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-999-c260-language-customization-mechanisms-coverage-final-diff-check.txt`; staged diff check passed in `project_memory/runlogs/20260709-1000-c260-language-customization-mechanisms-coverage-staged-diff-check.txt`.
- Audit: `project_memory/audit/reports/20260709-c260-language-customization-mechanisms-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 130

- Goal: make C260 Appendix A Summary of Language Notation auditable by exact outline identity while keeping exact vector artwork redistribution outside the committed repository boundary.
- Source check: `project_memory/runlogs/20260709-805-c260-outline-current-extract.txt` confirms the Appendix A outline includes A.1 Core Elements, A.2 Motivation, Strategy, Implementation and Migration Elements, and A.3 Relationships and Junctions.
- Red test: `project_memory/runlogs/20260709-1001-c260-appendix-a-notation-coverage-red-test.txt` failed because `appendixANotationCoverageCatalog` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `appendixANotationCoverageCatalog` and `appendixANotationCoverage` for the three Appendix A outline headings without committing exact Appendix A vector artwork.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().appendixANotationCoverage` with expected/actual/missing/extra ids, `missingAppendixANotationIds`, `extraAppendixANotationIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the exact Appendix A Summary of Language Notation outline boundary.
- Focused verification: `project_memory/runlogs/20260709-1002-c260-appendix-a-notation-coverage-focused-test.txt` passed for the Appendix A notation coverage identity test; `project_memory/runlogs/20260709-1003-c260-appendix-a-notation-coverage-status.json` shows expectedCount 3, actualCount 3, no missing Appendix A notation ids, no extra Appendix A notation ids, and complete true.
- Verification: `npm run test:language` passed with 178 tests in `project_memory/runlogs/20260709-1004-c260-appendix-a-notation-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1005-c260-appendix-a-notation-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-1006-c260-appendix-a-notation-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1007-c260-appendix-a-notation-coverage-diff-check.txt`; full registry scoped ESLint passed in `project_memory/runlogs/20260709-1008-c260-appendix-a-notation-coverage-eslint-registry-full.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-1009-c260-appendix-a-notation-coverage-demo-build.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1010-c260-appendix-a-notation-coverage-repo-lint.txt` with 4382 existing errors.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-1011-c260-appendix-a-notation-coverage-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1012-c260-appendix-a-notation-coverage-final-diff-check.txt`; staged diff check passed in `project_memory/runlogs/20260709-1013-c260-appendix-a-notation-coverage-staged-diff-check.txt`.
- Audit: `project_memory/audit/reports/20260709-c260-appendix-a-notation-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 131

- Goal: make C260 Appendix B Relationships auditable by exact outline identity while keeping B.5 relationship table data externally supplied.
- Source check: `project_memory/runlogs/20260709-805-c260-outline-current-extract.txt` confirms the Appendix B outline from B.1 through B.6, including valid derivations, potential derivations, restrictions, relationship tables, and grouping/plateau/relationships-between-relationships headings.
- Red test: `project_memory/runlogs/20260709-1014-c260-appendix-b-relationships-coverage-red-test.txt` failed because `appendixBRelationshipsCoverageCatalog` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `appendixBRelationshipsCoverageCatalog` and `appendixBRelationshipsCoverage` for the fifteen Appendix B outline headings without committing Appendix B relationship table data.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().appendixBRelationshipsCoverage` with expected/actual/missing/extra ids, `missingAppendixBRelationshipsIds`, `extraAppendixBRelationshipsIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the exact Appendix B Relationships outline boundary.
- Focused verification: `project_memory/runlogs/20260709-1015-c260-appendix-b-relationships-coverage-focused-test.txt` passed for the Appendix B Relationships coverage identity test; `project_memory/runlogs/20260709-1016-c260-appendix-b-relationships-coverage-status.json` shows expectedCount 15, actualCount 15, no missing Appendix B Relationships ids, no extra Appendix B Relationships ids, and complete true. B.5 Relationship Tables remains `external-profile-required`.
- Verification: `npm run test:language` passed with 179 tests in `project_memory/runlogs/20260709-1017-c260-appendix-b-relationships-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1018-c260-appendix-b-relationships-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-1019-c260-appendix-b-relationships-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1020-c260-appendix-b-relationships-coverage-diff-check.txt`; full registry scoped ESLint passed in `project_memory/runlogs/20260709-1021-c260-appendix-b-relationships-coverage-eslint-registry-full.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-1022-c260-appendix-b-relationships-coverage-demo-build.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1023-c260-appendix-b-relationships-coverage-repo-lint.txt` with 4382 existing errors.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-1024-c260-appendix-b-relationships-coverage-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1025-c260-appendix-b-relationships-coverage-final-diff-check.txt`; staged diff check passed in `project_memory/runlogs/20260709-1026-c260-appendix-b-relationships-coverage-staged-diff-check.txt`.
- Audit: `project_memory/audit/reports/20260709-c260-appendix-b-relationships-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 132

- Goal: make C260 Appendix C Example Viewpoints auditable by exact outline identity rather than only by broad optional Appendix C section coverage.
- Source check: `project_memory/runlogs/20260709-805-c260-outline-current-extract.txt` confirms the Appendix C outline from C.1 through C.4.3, including Basic, Motivation, Strategy, and Implementation and Migration viewpoint headings.
- Red test: `project_memory/runlogs/20260709-1027-c260-appendix-c-example-viewpoints-coverage-red-test.txt` failed because `appendixCExampleViewpointsCoverageCatalog` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `appendixCExampleViewpointsCoverageCatalog` and `appendixCExampleViewpointsCoverage` for the twenty-nine Appendix C outline headings without copying Example Viewpoints prose.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().appendixCExampleViewpointsCoverage` with expected/actual/missing/extra ids, `missingAppendixCExampleViewpointsIds`, `extraAppendixCExampleViewpointsIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the exact Appendix C Example Viewpoints outline boundary.
- Focused verification: `project_memory/runlogs/20260709-1028-c260-appendix-c-example-viewpoints-coverage-focused-test.txt` passed for the Appendix C Example Viewpoints coverage identity test; `project_memory/runlogs/20260709-1029-c260-appendix-c-example-viewpoints-coverage-status.json` shows expectedCount 29, actualCount 29, no missing Appendix C Example Viewpoints ids, no extra Appendix C Example Viewpoints ids, and complete true.
- Verification: `npm run test:language` passed with 180 tests in `project_memory/runlogs/20260709-1030-c260-appendix-c-example-viewpoints-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1031-c260-appendix-c-example-viewpoints-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-1032-c260-appendix-c-example-viewpoints-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1033-c260-appendix-c-example-viewpoints-coverage-diff-check.txt`; full registry scoped ESLint passed in `project_memory/runlogs/20260709-1034-c260-appendix-c-example-viewpoints-coverage-eslint-registry-full.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-1035-c260-appendix-c-example-viewpoints-coverage-demo-build.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1036-c260-appendix-c-example-viewpoints-coverage-repo-lint.txt` with 4382 existing errors.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-1037-c260-appendix-c-example-viewpoints-coverage-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1038-c260-appendix-c-example-viewpoints-coverage-final-diff-check.txt`; staged diff check passed in `project_memory/runlogs/20260709-1039-c260-appendix-c-example-viewpoints-coverage-staged-diff-check.txt`.
- Audit: `project_memory/audit/reports/20260709-c260-appendix-c-example-viewpoints-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 133

- Goal: make C260 Appendix D Relationship to Other Standards, Specifications, and Guidance Documents auditable by exact outline identity.
- Source check: `project_memory/runlogs/20260709-805-c260-outline-current-extract.txt` confirms the Appendix D outline from D.1 through D.6, including The TOGAF Standard, The BIZBOK Guide, Other Modeling Languages, BPMN, UML, and BMM headings.
- Red test: `project_memory/runlogs/20260709-1040-c260-appendix-d-standards-guidance-coverage-red-test.txt` failed because `appendixDStandardsGuidanceCoverageCatalog` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `appendixDStandardsGuidanceCoverageCatalog` and `appendixDStandardsGuidanceCoverage` for the six Appendix D outline headings without copying Appendix D prose.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().appendixDStandardsGuidanceCoverage` with expected/actual/missing/extra ids, `missingAppendixDStandardsGuidanceIds`, `extraAppendixDStandardsGuidanceIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the exact Appendix D standards/guidance outline boundary.
- Focused verification: `project_memory/runlogs/20260709-1041-c260-appendix-d-standards-guidance-coverage-focused-test.txt` passed for the Appendix D standards guidance coverage identity test; `project_memory/runlogs/20260709-1042-c260-appendix-d-standards-guidance-coverage-status.json` shows expectedCount 6, actualCount 6, no missing Appendix D standards guidance ids, no extra Appendix D standards guidance ids, and complete true.
- Verification: `npm run test:language` passed with 181 tests in `project_memory/runlogs/20260709-1043-c260-appendix-d-standards-guidance-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1044-c260-appendix-d-standards-guidance-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-1045-c260-appendix-d-standards-guidance-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1046-c260-appendix-d-standards-guidance-coverage-diff-check.txt`; full registry scoped ESLint passed in `project_memory/runlogs/20260709-1047-c260-appendix-d-standards-guidance-coverage-eslint-registry-full.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-1048-c260-appendix-d-standards-guidance-coverage-demo-build.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1049-c260-appendix-d-standards-guidance-coverage-repo-lint.txt` with 4382 existing errors.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-1050-c260-appendix-d-standards-guidance-coverage-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1051-c260-appendix-d-standards-guidance-coverage-final-diff-check.txt`; staged diff check passed in `project_memory/runlogs/20260709-1052-c260-appendix-d-standards-guidance-coverage-staged-diff-check.txt`.
- Audit: `project_memory/audit/reports/20260709-c260-appendix-d-standards-guidance-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 134

- Goal: make C260 Appendix E Changes from Version 2.1 to This Document auditable by exact outline identity, complementing the existing Appendix E migration corrections.
- Source check: `project_memory/runlogs/20260709-805-c260-outline-current-extract.txt` confirms the Appendix E outline from E.1 through E.4, including changes from 2.1 to 3.0.1, 3.0.1 to 3.1, 3.1 to 3.2, and 3.2 to this document.
- Red test: `project_memory/runlogs/20260709-1053-c260-appendix-e-version-changes-coverage-red-test.txt` failed because `appendixEVersionChangesCoverageCatalog` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `appendixEVersionChangesCoverageCatalog` and `appendixEVersionChangesCoverage` for the four Appendix E outline headings without copying Appendix E prose.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().appendixEVersionChangesCoverage` with expected/actual/missing/extra ids, `missingAppendixEVersionChangesIds`, `extraAppendixEVersionChangesIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the exact Appendix E version-change outline boundary.
- Focused verification: `project_memory/runlogs/20260709-1054-c260-appendix-e-version-changes-coverage-focused-test.txt` passed for the Appendix E version changes coverage identity test; `project_memory/runlogs/20260709-1055-c260-appendix-e-version-changes-coverage-status.json` shows expectedCount 4, actualCount 4, no missing Appendix E version changes ids, no extra Appendix E version changes ids, and complete true.
- Verification: `npm run test:language` passed with 182 tests in `project_memory/runlogs/20260709-1056-c260-appendix-e-version-changes-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1057-c260-appendix-e-version-changes-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-1058-c260-appendix-e-version-changes-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1059-c260-appendix-e-version-changes-coverage-diff-check.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-1060-c260-appendix-e-version-changes-coverage-demo-build.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1061-c260-appendix-e-version-changes-coverage-repo-lint.txt` with 4382 existing errors.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-1062-c260-appendix-e-version-changes-coverage-final-json-check.txt`; final `git diff --check` passed in `project_memory/runlogs/20260709-1064-c260-appendix-e-version-changes-coverage-final-diff-check.txt`; staged diff check passed in `project_memory/runlogs/20260709-1065-c260-appendix-e-version-changes-coverage-staged-diff-check.txt`.
- Audit: `project_memory/audit/reports/20260709-c260-appendix-e-version-changes-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 135

- Goal: make C260 Appendix F Acronyms auditable by exact acronym-token identity and fix the broad C260 section coverage catalog so it includes Appendix D and Appendix F.
- Source check: `project_memory/runlogs/20260709-805-c260-outline-current-extract.txt` confirms Appendix F: Acronyms after Appendix E; `project_memory/runlogs/20260709-1066-c260-appendix-f-acronyms-source-check.txt` records a derived acronym-token-only scan with 31 expected tokens, 31 actual tokens, no missing tokens, and no extra tokens.
- Red test: `project_memory/runlogs/20260709-1067-c260-appendix-f-acronyms-coverage-red-test.txt` failed because `appendixFAcronymsCoverageCatalog` was absent and `sectionCoverageCatalog.expectedCount` was still 18 instead of 20.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now includes Appendix D and Appendix F in broad `sectionCoverage`, and records `appendixFAcronymsCoverageCatalog` plus `appendixFAcronymsCoverage` for the 31 Appendix F acronym tokens without copying acronym expansions or Appendix F prose.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().appendixFAcronymsCoverage` with expected/actual/missing/extra ids, `missingAppendixFAcronymIds`, `extraAppendixFAcronymIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the Appendix F acronym-token boundary.
- Focused verification: `project_memory/runlogs/20260709-1068-c260-appendix-f-acronyms-coverage-focused-test.txt` passed for Appendix F and section coverage identity; `project_memory/runlogs/20260709-1069-c260-appendix-f-acronyms-coverage-status.json` shows sectionCoverage expectedCount 20, Appendix F expectedCount 31, no missing ids, no extra ids, and complete true.
- Verification: `npm run test:language` passed with 183 tests in `project_memory/runlogs/20260709-1070-c260-appendix-f-acronyms-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1071-c260-appendix-f-acronyms-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-1072-c260-appendix-f-acronyms-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1073-c260-appendix-f-acronyms-coverage-diff-check.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-1074-c260-appendix-f-acronyms-coverage-demo-build.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1075-c260-appendix-f-acronyms-coverage-repo-lint.txt` with 4382 existing errors.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-1076-c260-appendix-f-acronyms-coverage-final-json-check.txt`; final `git diff --check` passed in `project_memory/runlogs/20260709-1077-c260-appendix-f-acronyms-coverage-final-diff-check.txt`; staged diff check passed in `project_memory/runlogs/20260709-1078-c260-appendix-f-acronyms-coverage-staged-diff-check.txt`.
- Audit: `project_memory/audit/reports/20260709-c260-appendix-f-acronyms-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 136

- Goal: make the C260 `Index` outline artifact auditable without treating it as an ArchiMate language section, and refresh the official MEFF 4.0 XSD evidence.
- Official XSD recheck: `project_memory/runlogs/20260709-1079-meff4-xsd-latest-recheck.txt` shows the official directory and 3.1 directory returned 200, while the tested 4.0 directory and Model/Diagram/View/combined candidate XSD URLs returned 404.
- Red test: `project_memory/runlogs/20260709-1080-c260-document-artifact-coverage-red-test.txt` failed because `documentArtifactCoverageCatalog` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `documentArtifactCoverageCatalog` and `documentArtifactCoverage` for the C260 Index with `nonImplementation: true`, and updates `sourceCoverage.meff4Xsd` to the latest recheck runlog.
- Implemented: `lib/metamodel/languages/index.js` now exposes `getArchimate4ImplementationStatus().documentArtifactCoverage` with expected/actual/missing/extra ids, `missingDocumentArtifactIds`, `extraDocumentArtifactIds`, `nonImplementationIds`, `actualCount`, and `complete`.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now guard and describe the C260 document artifact boundary.
- Intermediate verification: `project_memory/runlogs/20260709-1081-c260-document-artifact-coverage-focused-test.txt` failed because the source coverage test still expected the previous MEFF 4.0 XSD runlog path; the test expectation was updated to the new official recheck evidence.
- Focused verification: `project_memory/runlogs/20260709-1082-c260-document-artifact-coverage-focused-test.txt` passed with 184 tests; `project_memory/runlogs/20260709-1083-c260-document-artifact-coverage-status.json` shows document artifact coverage complete, no missing or extra document artifact ids, and `sectionCoverage` still excludes `index`.
- Verification: `npm run test:language` passed with 184 tests in `project_memory/runlogs/20260709-1086-c260-document-artifact-coverage-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1087-c260-document-artifact-coverage-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-1084-c260-document-artifact-coverage-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1085-c260-document-artifact-coverage-diff-check.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-1088-c260-document-artifact-coverage-demo-build.txt`.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-1090-c260-document-artifact-coverage-final-json-check.txt`; final `git diff --check` passed in `project_memory/runlogs/20260709-1091-c260-document-artifact-coverage-final-diff-check.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1089-c260-document-artifact-coverage-repo-lint.txt` with 4382 existing errors.
- Audit: `project_memory/audit/reports/20260709-c260-document-artifact-coverage-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 137

- Goal: expand C260 document artifact coverage from the Index-only boundary to all non-language front matter outline artifacts plus Index.
- PDF source check: `project_memory/runlogs/20260709-1093-c260-document-artifacts-source-check.txt` extracted Cover, Title, Copyright, Table of Contents, Preface, The Open Group, This Document, Trademarks, Acknowledgements, Referenced Documents, and Index from `C:\Users\syska\Downloads\978940181474E.pdf`, with expected count 11, actual count 11, no missing items, and no extra items.
- Red test: `project_memory/runlogs/20260709-1094-c260-front-matter-document-artifacts-red-test.txt` failed because `documentArtifactCoverageCatalog` still referenced the earlier Index-only outline runlog.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records all 11 C260 document artifacts with `nonImplementation: true`, PDF page numbers, outline depth, and the new source-check runlog path.
- Tests/docs: `test/language-profile.test.mjs`, README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the implementation plan now describe the C260 front matter plus Index document artifact boundary.
- Focused verification: `project_memory/runlogs/20260709-1095-c260-front-matter-document-artifacts-focused-test.txt` passed with 184 tests; `project_memory/runlogs/20260709-1096-c260-front-matter-document-artifacts-status.json` shows document artifact coverage complete and confirms the front matter/Index ids are excluded from `sectionCoverage`.
- Verification: `npm run test:language` passed with 184 tests in `project_memory/runlogs/20260709-1099-c260-front-matter-document-artifacts-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1100-c260-front-matter-document-artifacts-eslint-changed.txt`; JSON parse check passed in `project_memory/runlogs/20260709-1097-c260-front-matter-document-artifacts-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1098-c260-front-matter-document-artifacts-diff-check.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-1101-c260-front-matter-document-artifacts-demo-build.txt`.
- Final pre-commit checks: JSON parse passed in `project_memory/runlogs/20260709-1103-c260-front-matter-document-artifacts-final-json-check.txt`; final `git diff --check` passed in `project_memory/runlogs/20260709-1104-c260-front-matter-document-artifacts-final-diff-check.txt`; staged diff check passed in `project_memory/runlogs/20260709-1105-c260-front-matter-document-artifacts-staged-diff-check.txt`.
...
- Goal: make C260 Chapter 13 Stakeholders and Concerns support machine-auditable separately from the broader viewpoint mechanism.
- Source evidence: `project_memory/runlogs/20260709-1299-c260-stakeholder-concern-feature-scan.txt` records Chapter 13 stakeholder/concern token presence by PDF page without copying normative prose.
- Red test: `project_memory/runlogs/20260709-1300-stakeholder-concern-status-red-test.txt` failed because `getArchimate4ImplementationStatus().stakeholderConcerns` was absent.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now records `stakeholderConcernCatalog` with expected feature ids and the source runlog path.
- Implemented: `lib/metamodel/languages/index.js` now derives `getArchimate4ImplementationStatus().stakeholderConcerns.actualFeatureIds` from the ArchiMate 4 moddle descriptor for `Viewpoint`, `Concern`, `Stakeholders`, and `Stakeholder`.
- Docs/tests: README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `test/language-profile.test.mjs` now guard and describe the `stakeholderConcerns` status fields.
- Focused verification: `project_memory/runlogs/20260709-1301-stakeholder-concern-status-focused-test.txt` and `project_memory/runlogs/20260709-1302-stakeholder-concern-status-focused-test-pass.txt` passed after implementation and doc checks.
- Verification: `npm run test:language` passed with 198 tests in `project_memory/runlogs/20260709-1303-stakeholder-concern-status-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1304-stakeholder-concern-status-eslint-changed.txt`; JSON parse passed in `project_memory/runlogs/20260709-1305-stakeholder-concern-status-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1306-stakeholder-concern-status-diff-check.txt`; `npm run demo:build` passed in `project_memory/runlogs/20260709-1307-stakeholder-concern-status-demo-build.txt`.
- Status evidence: `project_memory/runlogs/20260709-1308-stakeholder-concern-status.json` shows six expected and actual stakeholder/concern feature ids, no missing or extra ids, and complete true.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1309-stakeholder-concern-status-repo-lint.txt` with 4382 existing errors.
...
- Goal: strengthen the implementation-status completion audit so C260 coverage completeness and external blocker boundaries are backed by a parseable machine-readable runlog.
- Observation: `project_memory/runlogs/20260709-1453-status-completion-scan.json` records 46 top-level `getArchimate4ImplementationStatus()` keys, 37 `complete` summaries, and zero incomplete summaries; the companion stderr log is empty.
- Implemented: `test/language-profile.test.mjs` now verifies the completion-scan runlog parses cleanly, matches the live status API top-level keys and completion summary identities, and is documented in README, sources, official specification notes, and the implementation plan.
- Documentation: README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now point to the status-completion scan evidence.
- Focused verification: `project_memory/runlogs/20260709-1454-status-completion-scan-focused-test.txt` passed.
- Verification: `npm run test:language` passed with 216 tests in `project_memory/runlogs/20260709-1455-status-completion-scan-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1456-status-completion-scan-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1457-status-completion-scan-diff-check.txt`.
...
- Goal: refresh current external-source evidence for W262 and MEFF 4.0 XSD so official-conformance blockers stay tied to current evidence.
- Observation: `project_memory/runlogs/20260709-201226-external-source-current-recheck.json` records the official XSD directory returning 200 with only the 3.1 Diagram, Model, and View XSD links; tested 4.0 candidate URLs returned 404 and the 3.1 Model XSD baseline returned 200.
- Observation: the same runlog records the W262 publication page returning 200 with title, free PDF/login, 22-page, and 2026-04-27 publication markers; recursive local search under Downloads and Codex attachments still found no W262 or ArchiMate 4 motivation PDF candidate.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now points `sourceCoverage.w262` and `sourceCoverage.meff4Xsd` at the refreshed runlog and timestamp.
- Implemented: `test/language-profile.test.mjs` now verifies the refreshed source coverage evidence path and timestamp through the source-coverage boundary and runlog-alignment tests.
- Documentation: CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now cite the refreshed external-source evidence.
- Focused verification: JSON parse passed in `project_memory/runlogs/20260709-2013-external-source-201226-json-check.txt`; source coverage / MEFF / W262 focused test passed in `project_memory/runlogs/20260709-2014-external-source-201226-focused-test.txt`.
- Verification: `npm run test:language` passed with 223 tests in `project_memory/runlogs/20260709-2017-external-source-201226-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-2015-external-source-201226-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-2016-external-source-201226-diff-check.txt`.
...
- Goal: refresh the implementation-status completion API scan after adding C260 section status-key guards so the current status evidence includes the latest guard arrays.
- Observation: `implementationCompletion.sourceRunlogPath` still pointed at `project_memory/runlogs/20260709-2043-status-completion-api-scan.json`, which predated the section status-key reference guard even though the live status API was current.
- Implemented: `lib/metamodel/languages/index.js` now points `implementationCompletion.sourceRunlogPath` at `project_memory/runlogs/20260709-1008-status-completion-api-scan.json`.
- Implemented: `project_memory/runlogs/20260709-1008-status-completion-api-scan.json` now records 47 top-level status keys, 38 complete summaries, no incomplete summaries, and the section coverage status-key guard arrays.
- Implemented: `test/language-profile.test.mjs` now verifies the refreshed scan path and checks the scan's section status-key guard arrays against live `status.sectionCoverage`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now cite the refreshed scan.
- Focused verification: completion scan focused test passed with 87 tests in `project_memory/runlogs/20260709-1009-status-completion-api-refresh-focused-test.txt`.
- Verification: `npm run test:language` passed with 223 tests in `project_memory/runlogs/20260709-1010-status-completion-api-refresh-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1011-status-completion-api-refresh-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1012-status-completion-api-refresh-diff-check.txt`; JSON parse passed in `project_memory/runlogs/20260709-1014-status-completion-api-refresh-json-check.txt`.
- Final verification: JSON parse passed in `project_memory/runlogs/20260709-1015-status-completion-api-refresh-final-json-check.txt`; final `git diff --check` passed in `project_memory/runlogs/20260709-1016-status-completion-api-refresh-final-diff-check.txt`.
...
- Goal: expose the Appendix C informative example viewpoint catalog through `getArchimate4ImplementationStatus()` and refresh the completion scan so status consumers can audit it directly.
- Observation: `getArchimate4ExampleViewpointCatalog()` existed and returned four groups and 25 viewpoints, but `getArchimate4ImplementationStatus()` still reported 47 top-level keys and did not include `exampleViewpointCatalog`.
- Implemented: `lib/metamodel/languages/index.js` now adds `exampleViewpointCatalog` to the top-level implementation status, marks the catalog `complete: true`, and reports expected/actual group and viewpoint counts while keeping bundled definitions and normative relationship constraints false.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now links the optional Appendix C section status keys to `exampleViewpointCatalog`, so section coverage and status API key registration stay aligned.
- Implemented: `project_memory/runlogs/20260709-1061-status-completion-api-scan.json` now records 48 top-level status keys, 39 complete summaries, no incomplete summaries, and section coverage status-key guard arrays including `exampleViewpointCatalog`; the companion stderr log is empty.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now cite the 1061 completion scan and status-level Appendix C catalog boundary.
- Focused verification: completion/catalog/section coverage focused tests passed in `project_memory/runlogs/20260709-1062-archimate4-example-viewpoint-status-focused-test.txt`.
- Verification: changed-file ESLint passed in `project_memory/runlogs/20260709-1063-archimate4-example-viewpoint-status-eslint-changed.txt`; JSON parse passed in `project_memory/runlogs/20260709-1064-archimate4-example-viewpoint-status-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1065-archimate4-example-viewpoint-status-diff-check.txt`; `npm run test:language` passed with 226 tests in `project_memory/runlogs/20260709-1066-archimate4-example-viewpoint-status-test-language.txt`.
- Audit: completion audit passed in `project_memory/runlogs/20260709-1067-archimate4-example-viewpoint-status-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260709-1068-archimate4-example-viewpoint-status-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260709-archimate4-example-viewpoint-status-audit.md`.
- Final verification after state/audit updates: JSON parse passed in `project_memory/runlogs/20260709-1070-archimate4-example-viewpoint-status-final-json-check.txt`; final `git diff --check` passed in `project_memory/runlogs/20260709-1071-archimate4-example-viewpoint-status-final-diff-check.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1069-archimate4-example-viewpoint-status-repo-lint.txt` with 4382 existing errors.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 194

- Goal: add an official-spec-aligned model diagnostic API that can detect ArchiMate 3.x/4.0 profile mismatches, retired concepts, relationship errors, multiplicity errors, and junction consistency issues without embedding restricted Appendix B table data.
- Observation: `getArchimate4ImplementationStatus()` had 48 top-level keys, 39 complete summaries, and no incomplete summaries; remaining official gaps were external Appendix B matrix data, MEFF 4.0 XSD, exact Appendix A artwork rights, and W262 companion availability.
- Implemented: `lib/validation/archimate4-model.js` now exports `validateArchimate4Model(model, options)` and `validateArchimateModel(model, options)`, returning structured diagnostics with `valid`, `diagnosticCount`, `errorCount`, `warningCount`, `errors`, and `warnings`.
- Implemented: the validator checks element catalog membership, ArchiMate 4 retired ArchiMate 3 concepts and replacements, relationship type support, relationship endpoint support, active relationship profile allowance, multiplicity notation, multiplicity on junction-connected ends, mixed relationship types at a junction, and direct endpoint validity for chains through a junction.
- Implemented: the package root now exports `validateArchimate4Model` and `validateArchimateModel`.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now exposes expected/actual/missing/extra validation check ids and `complete: true`; the status completion scan now records 49 top-level keys, 40 complete summaries, and no incomplete summaries in `project_memory/runlogs/20260709-1080-status-completion-api-scan.json`.
- Implemented: `scripts/audit_archimate4_completion.mjs` now audits `modelValidation` as part of M3 semantics and checks the new validation implementation file.
- Tests: `test/model-validation.test.mjs` covers retired 3.x concepts in 4.0 mode, 4.0 concepts in 3.2 mode, unsupported relationship types/endpoints, host relationship validator calls, invalid/junction multiplicity, mixed junction relationship types, and root export coverage.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now describe the model validation API and the 1080 completion scan.
- Audit registry: `project_memory/audit/audit_registry.json` now includes `audit.archimate4.model_validation` and changed-file lint now includes `lib/validation/archimate4-model.js`.
- Verification: focused model validation test passed in `project_memory/runlogs/20260709-1081-archimate4-model-validation-focused-test.txt`; modelValidation/status focused tests passed in `project_memory/runlogs/20260709-1082-archimate4-model-validation-status-focused-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1083-archimate4-model-validation-eslint-changed.txt`.
- Verification: JSON parse passed in `project_memory/runlogs/20260709-1084-archimate4-model-validation-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1085-archimate4-model-validation-diff-check.txt`; `npm run test:language` passed with 234 tests in `project_memory/runlogs/20260709-1086-archimate4-model-validation-test-language.txt`.
- Audit: completion audit passed in `project_memory/runlogs/20260709-1087-archimate4-model-validation-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260709-1088-archimate4-model-validation-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260709-archimate4-model-validation-audit.md`.
- Final verification after state/audit updates: JSON parse passed in `project_memory/runlogs/20260709-1090-archimate4-model-validation-final-json-check.txt`; final `git diff --check` passed in `project_memory/runlogs/20260709-1091-archimate4-model-validation-final-diff-check.txt`; final status API check passed in `project_memory/runlogs/20260709-1092-archimate4-model-validation-status-api-check.txt`; final `npm run test:language` passed in `project_memory/runlogs/20260709-1093-archimate4-model-validation-final-test-language.txt`; post-state JSON parse passed in `project_memory/runlogs/20260709-1094-archimate4-model-validation-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260709-1095-archimate4-model-validation-post-state-diff-check.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1089-archimate4-model-validation-repo-lint.txt` with 4382 existing errors.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 195

- Goal: answer the official-spec extension question by implementing immediately available C260-derived validation coverage that does not depend on the missing Appendix B matrix, MEFF 4.0 XSD, or Appendix A artwork-rights sources.
- Observation: the current model validation API covered catalog/profile/multiplicity/junction checks, while C260-derived viewpoint classification and language customization profile attributes were already represented in the language profile and moddle descriptor.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now validate viewpoint `viewpointPurpose`, `viewpointContent`, `allowedElementTypes`, and `allowedRelationshipTypes` against the active profile and return structured diagnostics for unsupported tokens, unsupported types, and invalid type entries.
- Implemented: profile attribute Properties using the `archimate-js:profileAttribute:<concept>:<name>` key format are validated against the active profile attribute definitions, including typed value parsing for Integer/Number/Boolean/Date/URL/Time/Structure/etc.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `viewpoint-purpose-content`, `viewpoint-allowed-types`, `profile-attribute-properties`, and `profile-attribute-values`; the refreshed completion scan is `project_memory/runlogs/20260709-1096-status-completion-api-scan.json` with 49 top-level keys, 40 complete summaries, and no incomplete summaries.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now document the expanded model diagnostics and the 1096 completion scan.
- Audit registry: `project_memory/audit/audit_registry.json` now describes the expanded model-validation guarantee and points at the 1096/1097 evidence artifacts.
- Verification: focused model validation test passed in `project_memory/runlogs/20260709-1097-archimate4-model-validation-viewpoint-profile-focused-test.txt`; status focused tests passed in `project_memory/runlogs/20260709-1098-archimate4-model-validation-status-focused-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1099-archimate4-model-validation-viewpoint-profile-eslint-changed.txt`.
- Verification: JSON parse passed in `project_memory/runlogs/20260709-1100-archimate4-model-validation-viewpoint-profile-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1101-archimate4-model-validation-viewpoint-profile-diff-check.txt`; `npm run test:language` passed with 237 tests in `project_memory/runlogs/20260709-1102-archimate4-model-validation-viewpoint-profile-test-language.txt`.
- Audit: completion audit passed in `project_memory/runlogs/20260709-1103-archimate4-model-validation-viewpoint-profile-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260709-1104-archimate4-model-validation-viewpoint-profile-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260709-archimate4-model-validation-viewpoint-profile-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1105-archimate4-model-validation-viewpoint-profile-repo-lint.txt` with 4382 existing errors.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 196

- Goal: continue C260 Chapter 13 coverage by extending model diagnostics from viewpoint definitions to view viewpoint references and stakeholder/concern structures.
- Observation: `getArchimate4ImplementationStatus().viewpointMechanism` and `.stakeholderConcerns` exposed complete descriptor feature coverage, but `validateArchimate4Model()` did not yet diagnose malformed or unknown `View.viewpointRef` values or structurally invalid concern/stakeholder entries.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now collect model views from `views.diagrams.viewsList`, `views.diagrams.views`, `views.viewsList`, or `views.views`, and validate `viewpointRef` against model-defined Viewpoint ids.
- Implemented: Viewpoint concerns and concern stakeholder lists now produce structured diagnostics for invalid concern lists, invalid concern entries, non-string present labels/documentation, invalid stakeholder lists, invalid stakeholder entries, and non-string present stakeholder labels.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `view-viewpoint-reference` and `viewpoint-stakeholder-concern-structure`; the refreshed completion scan is `project_memory/runlogs/20260709-1109-status-completion-api-scan.json` with 49 top-level keys, 40 complete summaries, and no incomplete summaries.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now document the expanded view/viewpoint and stakeholder/concern diagnostics.
- Audit registry: `project_memory/audit/audit_registry.json` now describes the expanded model-validation guarantee and points at the 1109/1110 evidence artifacts.
- Verification: focused model validation test passed in `project_memory/runlogs/20260709-1110-archimate4-model-validation-view-reference-focused-test.txt`; status focused tests passed in `project_memory/runlogs/20260709-1111-archimate4-model-validation-view-reference-status-focused-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1112-archimate4-model-validation-view-reference-eslint-changed.txt`.
- Verification: JSON parse passed in `project_memory/runlogs/20260709-1113-archimate4-model-validation-view-reference-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1114-archimate4-model-validation-view-reference-diff-check.txt`; `npm run test:language` passed with 237 tests in `project_memory/runlogs/20260709-1115-archimate4-model-validation-view-reference-test-language.txt`.
- Audit: completion audit passed in `project_memory/runlogs/20260709-1116-archimate4-model-validation-view-reference-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260709-1117-archimate4-model-validation-view-reference-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260709-archimate4-model-validation-view-reference-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1118-archimate4-model-validation-view-reference-repo-lint.txt` with 4382 existing errors.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 197

- Goal: continue C260 view-structure coverage by validating diagram `Node.elementRef` and `Connection.relationshipRef` values against model-defined concepts.
- Observation: `validateArchimate4Model()` already validated model elements, relationships, viewpoints, and `View.viewpointRef`, but did not yet catch a view node pointing to a relationship, a view connection pointing to an element, malformed refs, unknown refs, or refs to unsupported active-profile types.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now build separate element and relationship indexes, traverse root `viewElements` and nested `Node.nodes`, and report structured diagnostics for invalid, unknown, wrong-kind, or unsupported view element references.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `view-node-element-reference` and `view-connection-relationship-reference`; the refreshed completion scan is `project_memory/runlogs/20260709-1125-status-completion-api-scan.json` with 49 top-level keys, 40 complete summaries, and no incomplete summaries.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now document the expanded view node/connection reference diagnostics.
- Audit registry: `project_memory/audit/audit_registry.json` now describes the expanded model-validation guarantee and points at the 1125/1128 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260709-1122-archimate4-model-validation-view-element-red-test.txt`; focused test passed in `project_memory/runlogs/20260709-1123-archimate4-model-validation-view-element-focused-test.txt`; status/doc focused tests passed in `project_memory/runlogs/20260709-1124-archimate4-model-validation-view-element-status-focused-test.txt` and `project_memory/runlogs/20260709-1127-archimate4-model-validation-view-element-status-doc-test.txt`.
- Verification: full model validation test passed in `project_memory/runlogs/20260709-1128-archimate4-model-validation-view-element-full-model-test.txt`; JSON parse passed in `project_memory/runlogs/20260709-1129-archimate4-model-validation-view-element-json-check.txt`; `npm run test:language` passed with 239 tests in `project_memory/runlogs/20260709-1130-archimate4-model-validation-view-element-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1131-archimate4-model-validation-view-element-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1132-archimate4-model-validation-view-element-diff-check.txt`.
- Audit: completion audit passed in `project_memory/runlogs/20260709-1133-archimate4-model-validation-view-element-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260709-1134-archimate4-model-validation-view-element-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260709-archimate4-model-validation-view-element-audit.md`.
- Final verification after state/audit updates: JSON parse passed in `project_memory/runlogs/20260709-1137-archimate4-model-validation-view-element-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260709-1138-archimate4-model-validation-view-element-post-state-diff-check.txt`; final `npm run test:language` passed with 239 tests in `project_memory/runlogs/20260709-1139-archimate4-model-validation-view-element-final-test-language.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1136-archimate4-model-validation-view-element-repo-lint.txt` with 4382 existing errors.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 198

- Goal: continue C260 Chapter 13 Viewpoint mechanism coverage by applying a model-defined Viewpoint's allowed element and relationship type lists to the actual contents of each referencing View.
- Observation: `validateArchimate4Model()` validated Viewpoint definitions and view node/connection references, but a View could still use an element or relationship type outside the referenced Viewpoint's allowed lists without an error.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now resolve `View.viewpointRef`, collect root and nested View elements, and report `view-node-outside-viewpoint-element-types` or `view-connection-outside-viewpoint-relationship-types` when referenced element or relationship types are outside the Viewpoint's allowed type lists.
- Implemented: allowed-type application respects custom specializations by accepting either the exact type or the active-profile base type.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `view-viewpoint-content-application`; the refreshed completion scan is `project_memory/runlogs/20260709-1142-status-completion-api-scan.json` with 49 top-level keys, 40 complete summaries, and no incomplete summaries.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now document Viewpoint allowed-type application to View contents.
- Audit registry: `project_memory/audit/audit_registry.json` now describes the expanded model-validation guarantee and points at the 1142/1145 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260709-1141-archimate4-model-validation-viewpoint-application-red-test.txt`; focused test passed in `project_memory/runlogs/20260709-1143-archimate4-model-validation-viewpoint-application-focused-test.txt`; status focused test passed in `project_memory/runlogs/20260709-1144-archimate4-model-validation-viewpoint-application-status-focused-test.txt`.
- Verification: full model validation test passed in `project_memory/runlogs/20260709-1145-archimate4-model-validation-viewpoint-application-full-model-test.txt`; JSON parse passed in `project_memory/runlogs/20260709-1146-archimate4-model-validation-viewpoint-application-json-check.txt`; `npm run test:language` passed with 241 tests in `project_memory/runlogs/20260709-1147-archimate4-model-validation-viewpoint-application-test-language.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-1148-archimate4-model-validation-viewpoint-application-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1149-archimate4-model-validation-viewpoint-application-diff-check.txt`.
- Audit: completion audit passed in `project_memory/runlogs/20260709-1150-archimate4-model-validation-viewpoint-application-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260709-1151-archimate4-model-validation-viewpoint-application-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260709-archimate4-model-validation-viewpoint-application-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1152-archimate4-model-validation-viewpoint-application-repo-lint.txt` with 4382 existing errors.
- Final verification after state/audit updates: JSON parse passed in `project_memory/runlogs/20260709-1153-archimate4-model-validation-viewpoint-application-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260709-1154-archimate4-model-validation-viewpoint-application-post-state-diff-check.txt`; final `npm run test:language` passed with 241 tests in `project_memory/runlogs/20260709-1155-archimate4-model-validation-viewpoint-application-final-test-language.txt`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 199

- Goal: extend C260 Chapter 13 Viewpoint mechanism coverage by applying active-profile Viewpoint definitions named through `View.viewpoint`.
- Observation: model-defined `View.viewpointRef` allowed-type application was implemented, but profile-defined Viewpoints supplied through `archimateLanguageProfile.viewpoints` were not applied when a View named them through `View.viewpoint`.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now index active-profile viewpoints, use model-defined `viewpointRef` first, then resolve `View.viewpoint` as a profile Viewpoint name, applying the same allowed element/relationship type checks to View contents.
- Implemented: unknown `View.viewpoint` names remain retained metadata rather than validation errors.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `view-profile-viewpoint-content-application`; the refreshed completion scan is `project_memory/runlogs/20260709-1160-status-completion-api-scan.json`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now describe model-defined and profile-defined Viewpoint allowed-type application.
- Audit registry: the model-validation guarantee now includes model-defined and profile-defined viewpoint allowed-type application and points to the 1160/1163 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260709-1158-archimate4-model-validation-profile-viewpoint-application-red-test.txt`; focused test passed in `project_memory/runlogs/20260709-1159-archimate4-model-validation-profile-viewpoint-application-focused-test.txt`; status focused test passed in `project_memory/runlogs/20260709-1161-archimate4-model-validation-profile-viewpoint-application-status-focused-test.txt`.
- Verification: changed-file ESLint passed in `project_memory/runlogs/20260709-1162-archimate4-model-validation-profile-viewpoint-application-eslint-changed.txt`; full model validation test passed with 16 tests in `project_memory/runlogs/20260709-1163-archimate4-model-validation-profile-viewpoint-application-full-model-test.txt`; JSON parse passed in `project_memory/runlogs/20260709-1164-archimate4-model-validation-profile-viewpoint-application-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-1165-archimate4-model-validation-profile-viewpoint-application-diff-check.txt`.
- Audit: completion audit passed in `project_memory/runlogs/20260709-1166-archimate4-model-validation-profile-viewpoint-application-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260709-1167-archimate4-model-validation-profile-viewpoint-application-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260709-archimate4-model-validation-profile-viewpoint-application-audit.md`.
- Verification: `npm run test:language` passed with 243 tests in `project_memory/runlogs/20260709-1168-archimate4-model-validation-profile-viewpoint-application-test-language.txt`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-1169-archimate4-model-validation-profile-viewpoint-application-repo-lint.txt` with 4382 existing errors; changed-file lint remains clean.
- Final verification after state/audit updates: JSON parse passed in `project_memory/runlogs/20260709-1170-archimate4-model-validation-profile-viewpoint-application-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260709-1171-archimate4-model-validation-profile-viewpoint-application-post-state-diff-check.txt`; final `npm run test:language` passed with 243 tests in `project_memory/runlogs/20260709-1172-archimate4-model-validation-profile-viewpoint-application-final-test-language.txt`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 200

- Goal: close a C260 Chapter 13 Model Organization Tree validation gap by checking `Organization.identifierRef` references in model diagnostics.
- Observation: the 4.0 moddle descriptor and XML round-trip tests retained `organizationsNode`, nested `Organization` entries, and optional `identifierRef`, but `validateArchimate4Model()` did not report malformed, unknown, or active-profile unsupported organization references.
- External source recheck: `project_memory/runlogs/20260709-1174-external-source-current-recheck.json` confirmed the official XSD directory still exposes only 3.1 links, tested 4.0 candidates still return 404, W262 publication metadata is visible, and no local W262 PDF candidate is present.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now traverse `organizationsNode.organizations` recursively and validate `identifierRef` against model-defined elements and relationships.
- Implemented: new diagnostics report invalid organization entries/lists, malformed `identifierRef`, unknown referenced ids, and referenced concept types unsupported by the active profile.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `organization-identifier-reference`; the refreshed completion scan is `project_memory/runlogs/20260709-2200-status-completion-api-scan.json`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now describe organization reference validation and the 1174/2200 evidence.
- Audit registry: the model-validation guarantee now includes organization identifier references and points to the 2200/2202 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260709-1176-archimate4-model-validation-organization-reference-red-test.txt`; focused organization tests passed in `project_memory/runlogs/20260709-1177-archimate4-model-validation-organization-reference-focused-test.txt`; status/source focused tests passed in `project_memory/runlogs/20260709-2201-archimate4-model-validation-organization-reference-status-focused-test.txt`.
- Verification: full model validation passed with 18 tests in `project_memory/runlogs/20260709-2202-archimate4-model-validation-organization-reference-full-model-test.txt`; JSON parse passed in `project_memory/runlogs/20260709-2203-archimate4-model-validation-organization-reference-json-check.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-2204-archimate4-model-validation-organization-reference-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-2205-archimate4-model-validation-organization-reference-diff-check.txt`.
- Audit: `npm run test:language` passed with 245 tests in `project_memory/runlogs/20260709-2206-archimate4-model-validation-organization-reference-test-language.txt`; completion audit passed in `project_memory/runlogs/20260709-2207-archimate4-model-validation-organization-reference-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260709-2208-archimate4-model-validation-organization-reference-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260709-archimate4-model-validation-organization-reference-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-2209-archimate4-model-validation-organization-reference-repo-lint.txt` with 4382 existing errors; changed-file lint remains clean.
- Final verification after state/audit updates: JSON parse passed in `project_memory/runlogs/20260709-2213-archimate4-model-validation-organization-reference-final-json-check.txt`; final `git diff --check` passed in `project_memory/runlogs/20260709-2214-archimate4-model-validation-organization-reference-final-diff-check.txt`; final `npm run test:language` passed with 245 tests in `project_memory/runlogs/20260709-2212-archimate4-model-validation-organization-reference-final-test-language.txt`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-09 loop 201

- Goal: continue C260 language customization and model property coverage by validating MEFF-style `Property.propertyDefinitionRef` references used by profile attribute properties.
- Observation: `lib/moddle/resources/archimate4.json` exposes model-level `propertyDefinitionsNode`, reusable `PropertyDefinition` entries, and per-object `Properties`, but `validateArchimate4Model()` only read embedded `propertyDefinitionRef.name` values and did not diagnose missing, malformed, or unknown string id references.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now index `model.propertyDefinitionsNode.propertyDefinitions`, collect known model property owners, and report missing, malformed, unknown, invalid property list, or invalid property entry diagnostics for `Property.propertyDefinitionRef`.
- Implemented: profile attribute property validation now resolves string property-definition ids through the model-level definition index before applying active-profile attribute/value checks.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `property-definition-reference`; the refreshed completion scan is `project_memory/runlogs/20260709-2303-status-completion-api-scan.json`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now describe property definition reference validation and the 2303 evidence.
- Audit registry: the model-validation guarantee now includes property definition references and points to the 2303/2304 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260709-2301-archimate4-model-validation-property-definition-red-test.txt`; focused property-definition tests passed in `project_memory/runlogs/20260709-2302-archimate4-model-validation-property-definition-focused-test.txt`.
- Verification: full model validation passed with 20 tests in `project_memory/runlogs/20260709-2304-archimate4-model-validation-property-definition-full-model-test.txt`; status focused tests passed in `project_memory/runlogs/20260709-2305-archimate4-model-validation-property-definition-status-focused-test.txt`.
- Verification: JSON parse passed in `project_memory/runlogs/20260709-2306-archimate4-model-validation-property-definition-json-check.txt`; changed-file ESLint passed in `project_memory/runlogs/20260709-2307-archimate4-model-validation-property-definition-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260709-2308-archimate4-model-validation-property-definition-diff-check.txt`.
- Audit: `npm run test:language` passed with 247 tests in `project_memory/runlogs/20260709-2309-archimate4-model-validation-property-definition-test-language.txt`; completion audit passed in `project_memory/runlogs/20260709-2310-archimate4-model-validation-property-definition-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260709-2311-archimate4-model-validation-property-definition-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260709-archimate4-model-validation-property-definition-reference-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260709-2312-archimate4-model-validation-property-definition-repo-lint.txt` with 4382 existing errors; changed-file lint remains clean.
- Final verification after state/audit updates: JSON parse passed in `project_memory/runlogs/20260709-2313-archimate4-model-validation-property-definition-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260709-2314-archimate4-model-validation-property-definition-post-state-diff-check.txt`; final `npm run test:language` passed with 247 tests in `project_memory/runlogs/20260709-2315-archimate4-model-validation-property-definition-final-test-language.txt`.
- Additional guard: invalid non-array `propertiesNode.properties` on a property owner is now covered by `project_memory/runlogs/20260709-2318-archimate4-model-validation-property-definition-invalid-properties-focused-test.txt`, with final full model validation in `project_memory/runlogs/20260709-2319-archimate4-model-validation-property-definition-final-full-model-test.txt`, changed-file lint in `project_memory/runlogs/20260709-2320-archimate4-model-validation-property-definition-final-eslint-changed.txt`, and final language tests in `project_memory/runlogs/20260709-2321-archimate4-model-validation-property-definition-final-test-language-rerun.txt`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 202

- Goal: continue official C260 viewpoint mechanism coverage by validating `Viewpoint.modelingNotes` structure in model diagnostics.
- Observation: `lib/moddle/resources/archimate4.json` and the status viewpoint mechanism already expose `modelingNotes`, but `validateArchimate4Model()` accepted invalid `modelingNotes` lists and note fields without diagnostics.
- Implemented: `validateArchimate4Model()` now reports invalid `modelingNotes` list shape, invalid note entries, and non-string optional `type` / `documentation` fields.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `viewpoint-modeling-note-structure`; the refreshed completion scan is `project_memory/runlogs/20260710-0003-status-completion-api-scan.json`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now describe viewpoint modeling-note validation and the 0003 evidence.
- Audit registry: the model-validation guarantee now includes modeling-note structure and points to the 0003/0005 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260710-0001-archimate4-model-validation-modeling-note-red-test.txt`; focused model tests passed in `project_memory/runlogs/20260710-0002-archimate4-model-validation-modeling-note-focused-test.txt`; status focused tests passed in `project_memory/runlogs/20260710-0004-archimate4-model-validation-modeling-note-status-focused-test.txt`.
- Verification: full model validation passed in `project_memory/runlogs/20260710-0005-archimate4-model-validation-modeling-note-full-model-test.txt`; JSON parse passed in `project_memory/runlogs/20260710-0006-archimate4-model-validation-modeling-note-json-check.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0007-archimate4-model-validation-modeling-note-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0008-archimate4-model-validation-modeling-note-diff-check.txt`.
- Audit: `npm run test:language` passed with 248 tests in `project_memory/runlogs/20260710-0009-archimate4-model-validation-modeling-note-test-language.txt`; completion audit passed in `project_memory/runlogs/20260710-0010-archimate4-model-validation-modeling-note-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260710-0011-archimate4-model-validation-modeling-note-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260710-archimate4-model-validation-modeling-note-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260710-0012-archimate4-model-validation-modeling-note-repo-lint.txt` with 4382 existing errors; changed-file lint remains clean.
- Final verification after state/audit updates: state update passed in `project_memory/runlogs/20260710-0013-archimate4-model-validation-modeling-note-state-update.txt`; post-state JSON parse passed in `project_memory/runlogs/20260710-0014-archimate4-model-validation-modeling-note-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260710-0015-archimate4-model-validation-modeling-note-post-state-diff-check.txt`; final `npm run test:language` passed with 248 tests in `project_memory/runlogs/20260710-0016-archimate4-model-validation-modeling-note-final-test-language.txt`.
- Final guard after report/worklog update: JSON parse passed in `project_memory/runlogs/20260710-0017-archimate4-model-validation-modeling-note-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0018-archimate4-model-validation-modeling-note-final-diff-check.txt`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 203

- Goal: continue MEFF/C260 model property coverage by validating reusable `PropertyDefinition` structures before reference and profile-attribute validation.
- Observation: `PropertyDefinition` entries are modeled under `propertyDefinitionsNode.propertyDefinitions`, but a non-array list caused `validateArchimate4Model()` to throw before diagnostics and invalid entry/id/name/type shapes were accepted as valid.
- Implemented: `validateArchimate4Model()` now reports invalid property-definition list, entry, id, name, and type diagnostics while preserving existing inline `propertyDefinitionRef` name compatibility.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `property-definition-structure`; the refreshed completion scan is `project_memory/runlogs/20260710-0023-status-completion-api-scan.json`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now describe property-definition structure validation and the 0023 evidence.
- Audit registry: the model-validation guarantee now includes property definition structure and references and points to the 0023/0025 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260710-0021-archimate4-model-validation-property-definition-structure-red-test.txt`; focused model tests passed in `project_memory/runlogs/20260710-0022-archimate4-model-validation-property-definition-structure-focused-test.txt`; status focused tests passed in `project_memory/runlogs/20260710-0024-archimate4-model-validation-property-definition-structure-status-focused-test.txt`.
- Verification: full model validation passed in `project_memory/runlogs/20260710-0025-archimate4-model-validation-property-definition-structure-full-model-test.txt`; JSON parse passed in `project_memory/runlogs/20260710-0026-archimate4-model-validation-property-definition-structure-json-check.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0027-archimate4-model-validation-property-definition-structure-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0028-archimate4-model-validation-property-definition-structure-diff-check.txt`.
- Audit: `npm run test:language` passed with 250 tests in `project_memory/runlogs/20260710-0029-archimate4-model-validation-property-definition-structure-test-language.txt`; completion audit passed in `project_memory/runlogs/20260710-0030-archimate4-model-validation-property-definition-structure-completion-audit.json`; C260 coverage audit passed in `project_memory/runlogs/20260710-0031-archimate4-model-validation-property-definition-structure-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260710-archimate4-model-validation-property-definition-structure-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260710-0032-archimate4-model-validation-property-definition-structure-repo-lint.txt` with 4382 existing errors; changed-file lint remains clean.
- Final verification after state/audit updates: state update passed in `project_memory/runlogs/20260710-0033-archimate4-model-validation-property-definition-structure-state-update.txt`; post-state JSON parse passed in `project_memory/runlogs/20260710-0034-archimate4-model-validation-property-definition-structure-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260710-0035-archimate4-model-validation-property-definition-structure-post-state-diff-check.txt`; final `npm run test:language` passed with 250 tests in `project_memory/runlogs/20260710-0036-archimate4-model-validation-property-definition-structure-final-test-language.txt`.
- Final guard after report/worklog update: JSON parse passed in `project_memory/runlogs/20260710-0037-archimate4-model-validation-property-definition-structure-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0038-archimate4-model-validation-property-definition-structure-final-diff-check.txt`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 204

- Goal: close an ArchiMate 4 diagram validation gap by checking `Connection.source` and `Connection.target` references against the `ViewElement` ids in the same `View`.
- Observation: `lib/moddle/resources/archimate4.json` exposes `Connection.source` and `Connection.target` as `ViewElement` references, but `validateArchimate4Model()` only validated `relationshipRef`; malformed or unknown endpoint refs were accepted.
- Implemented: `validateArchimate4Model()` now indexes view elements per view and reports invalid or unknown `source` / `target` endpoint references with structured diagnostics.
- Compatibility decision: missing endpoint refs remain tolerated so partial in-memory editor fixtures and existing ArchiMate 3.x behavior are not broken; present refs must be valid.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `view-connection-endpoint-reference`; the refreshed completion scan is `project_memory/runlogs/20260710-0043-status-completion-api-scan.json`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now describe view connection relationship and endpoint reference validation.
- Audit registry: the model-validation guarantee now includes view connection endpoint references and points to the 0044/0043 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260710-0041-archimate4-model-validation-view-connection-endpoint-red-test.txt`; focused test passed in `project_memory/runlogs/20260710-0042-archimate4-model-validation-view-connection-endpoint-focused-test.txt`.
- Verification: full model validation passed with 24 tests in `project_memory/runlogs/20260710-0044-archimate4-model-validation-view-connection-endpoint-full-model-test.txt`; status focused tests passed in `project_memory/runlogs/20260710-0045-archimate4-model-validation-view-connection-endpoint-status-focused-test.txt`; JSON parse passed in `project_memory/runlogs/20260710-0046-archimate4-model-validation-view-connection-endpoint-json-check.txt`.
- Verification: changed-file ESLint passed in `project_memory/runlogs/20260710-0047-archimate4-model-validation-view-connection-endpoint-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0048-archimate4-model-validation-view-connection-endpoint-diff-check.txt`; `npm run test:language` passed with 251 tests in `project_memory/runlogs/20260710-0049-archimate4-model-validation-view-connection-endpoint-test-language.txt`.
- Audit: completion audit passed with no failures in `project_memory/runlogs/20260710-0050-archimate4-model-validation-view-connection-endpoint-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0051-archimate4-model-validation-view-connection-endpoint-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260710-archimate4-model-validation-view-connection-endpoint-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260710-0052-archimate4-model-validation-view-connection-endpoint-repo-lint.txt` with 4382 existing errors; changed-file lint remains clean.
- Final verification after state/audit updates: JSON parse passed in `project_memory/runlogs/20260710-0053-archimate4-model-validation-view-connection-endpoint-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260710-0054-archimate4-model-validation-view-connection-endpoint-post-state-diff-check.txt`; final `npm run test:language` passed with 251 tests in `project_memory/runlogs/20260710-0055-archimate4-model-validation-view-connection-endpoint-final-test-language.txt`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 205

- Goal: strengthen ArchiMate 4 diagram validation by checking that a view `Connection` endpoint resolves to the same model concept as the referenced relationship source/target.
- Observation: loop 204 validated that `Connection.source` and `Connection.target` point to existing ViewElements, but a connection could still visually connect the referenced relationship to reversed or unrelated endpoint concepts without diagnostics.
- Implemented: `validateArchimate4Model()` now reports `view-connection-source-concept-mismatch` and `view-connection-target-concept-mismatch` when a valid endpoint ViewElement's `elementRef` or `relationshipRef` does not match the referenced relationship source/target concept id.
- Compatibility decision: endpoint alignment is checked only when the `relationshipRef` resolves and the endpoint ViewElement has a model concept reference; partial in-memory editor nodes remain tolerated until they carry refs.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `view-connection-endpoint-alignment`; the refreshed completion scan is `project_memory/runlogs/20260710-0061-status-completion-api-scan.json`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now describe view connection relationship refs, endpoint refs, and endpoint-to-relationship alignment.
- Audit registry: the model-validation guarantee now includes endpoint-to-relationship alignment and points to the 0063/0061 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260710-0059-archimate4-model-validation-view-connection-endpoint-alignment-red-test.txt`; focused test passed in `project_memory/runlogs/20260710-0060-archimate4-model-validation-view-connection-endpoint-alignment-focused-test.txt`; status focused tests passed in `project_memory/runlogs/20260710-0062-archimate4-model-validation-view-connection-endpoint-alignment-status-focused-test.txt`.
- Verification: full model validation passed with 25 tests in `project_memory/runlogs/20260710-0063-archimate4-model-validation-view-connection-endpoint-alignment-full-model-test.txt`; JSON parse passed in `project_memory/runlogs/20260710-0064-archimate4-model-validation-view-connection-endpoint-alignment-json-check.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0065-archimate4-model-validation-view-connection-endpoint-alignment-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0066-archimate4-model-validation-view-connection-endpoint-alignment-diff-check.txt`.
- Audit: `npm run test:language` passed with 252 tests in `project_memory/runlogs/20260710-0067-archimate4-model-validation-view-connection-endpoint-alignment-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0068-archimate4-model-validation-view-connection-endpoint-alignment-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0069-archimate4-model-validation-view-connection-endpoint-alignment-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260710-archimate4-model-validation-view-connection-endpoint-alignment-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260710-0070-archimate4-model-validation-view-connection-endpoint-alignment-repo-lint.txt` with 4382 existing errors; changed-file lint remains clean.
- Final verification after state/audit updates: JSON parse passed in `project_memory/runlogs/20260710-0071-archimate4-model-validation-view-connection-endpoint-alignment-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260710-0072-archimate4-model-validation-view-connection-endpoint-alignment-post-state-diff-check.txt`; final `npm run test:language` passed with 252 tests in `project_memory/runlogs/20260710-0073-archimate4-model-validation-view-connection-endpoint-alignment-final-test-language.txt`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 206

- Goal: add an Official-specification-derived ArchiMate diagram validation guard by checking present view node geometry values.
- Observation: `project_memory/runlogs/20260710-0077-official-diagram-geometry-source-check.txt` records the public Open Group ArchiMate 3.1 Diagram XSD geometry attributes: node `x` and `y` are non-negative coordinates, and `w` and `h` are positive dimensions. The local ArchiMate 4 descriptor exposes `Node` geometry as `x:Real`, `y:Real`, `w:Real`, and `h:Real`.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report invalid present view node `x`, `y`, `w`, and `h` values with `invalid-view-node-x`, `invalid-view-node-y`, `invalid-view-node-width`, and `invalid-view-node-height` diagnostics.
- Compatibility decision: missing geometry remains tolerated for partial in-memory editor nodes; present values must be finite numbers, with `x`/`y` non-negative and `w`/`h` positive. Integer-only enforcement is intentionally deferred until the official MEFF 4.0 XSD confirms stricter constraints because the ArchiMate 4 descriptor uses `Real`.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `view-node-geometry`; the refreshed completion scan is `project_memory/runlogs/20260710-0080-status-completion-api-scan.json`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now describe view node geometry validation and point at the 0080 completion scan.
- Audit registry: the model-validation guarantee now includes view node geometry and points to the 0082/0080 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260710-0078-archimate4-model-validation-view-node-geometry-red-test.txt`; focused geometry test passed in `project_memory/runlogs/20260710-0079-archimate4-model-validation-view-node-geometry-focused-test.txt`; status focused tests passed in `project_memory/runlogs/20260710-0081-archimate4-model-validation-view-node-geometry-status-focused-test.txt`.
- Verification: full model validation passed with 26 tests in `project_memory/runlogs/20260710-0082-archimate4-model-validation-view-node-geometry-full-model-test.txt`; JSON parse passed in `project_memory/runlogs/20260710-0083-archimate4-model-validation-view-node-geometry-json-check.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0084-archimate4-model-validation-view-node-geometry-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0085-archimate4-model-validation-view-node-geometry-diff-check.txt`.
- Audit: `npm run test:language` passed with 253 tests in `project_memory/runlogs/20260710-0086-archimate4-model-validation-view-node-geometry-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0087-archimate4-model-validation-view-node-geometry-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0088-archimate4-model-validation-view-node-geometry-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260710-archimate4-model-validation-view-node-geometry-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260710-0089-archimate4-model-validation-view-node-geometry-repo-lint.txt` with 4382 existing errors; changed-file ESLint remains clean.
- Final verification after state/audit updates: state update passed in `project_memory/runlogs/20260710-0090-archimate4-model-validation-view-node-geometry-state-update.txt`; post-state JSON parse passed in `project_memory/runlogs/20260710-0091-archimate4-model-validation-view-node-geometry-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260710-0092-archimate4-model-validation-view-node-geometry-post-state-diff-check.txt`; final `npm run test:language` passed with 253 tests in `project_memory/runlogs/20260710-0093-archimate4-model-validation-view-node-geometry-final-test-language.txt`.
- Final guard after runlog/report updates: runlog trimming passed in `project_memory/runlogs/20260710-0094-archimate4-model-validation-view-node-geometry-trim-runlogs.txt`; JSON parse passed in `project_memory/runlogs/20260710-0095-archimate4-model-validation-view-node-geometry-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0096-archimate4-model-validation-view-node-geometry-final-diff-check.txt`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 207

- Goal: add another Official-specification-derived ArchiMate diagram validation guard by checking view connection waypoint coordinates.
- Observation: `project_memory/runlogs/20260710-0099-official-diagram-waypoint-source-check.txt` records the public Open Group ArchiMate 3.1 Diagram XSD connection `bendpoint` entries as `LocationType` with required non-negative `x` and `y` coordinates. The local ArchiMate 4 descriptor exposes `Connection.waypointsNode: Waypoints`, `Waypoints.waypoints: Waypoint[]`, `Waypoint.original: Point`, and `Point.x/y: Integer`.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report invalid present view connection waypoint `x` and `y` values with `invalid-view-connection-waypoint-x` and `invalid-view-connection-waypoint-y` diagnostics.
- Implemented: malformed waypoint container/list/entry/original-point values are reported as `invalid-view-connection-waypoints-node`, `invalid-view-connection-waypoint-list`, `invalid-view-connection-waypoint-entry`, and `invalid-view-connection-waypoint-original`.
- Compatibility decision: absent `waypointsNode` and absent `waypointsNode.waypoints` remain tolerated for partial editor state; present waypoint point objects must carry finite non-negative integer `x` and `y` values because the ArchiMate 4 descriptor declares `Point.x/y` as `Integer`.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `view-connection-waypoint-geometry`; the refreshed completion scan is `project_memory/runlogs/20260710-0102-status-completion-api-scan.json`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and `docs/superpowers/plans/2026-07-08-archimate-4-support.md` now describe view connection waypoint geometry validation and point at the 0102 completion scan.
- Audit registry: the model-validation guarantee now includes waypoint geometry and points to the 0104/0102 evidence artifacts.
- Verification: red test failed before implementation in `project_memory/runlogs/20260710-0100-archimate4-model-validation-view-connection-waypoint-geometry-red-test.txt`; focused waypoint geometry test passed in `project_memory/runlogs/20260710-0101-archimate4-model-validation-view-connection-waypoint-geometry-focused-test.txt`.
- Verification: the first status focused test failed in `project_memory/runlogs/20260710-0103-archimate4-model-validation-view-connection-waypoint-geometry-status-focused-test.txt` because the regenerated scan omitted existing section status-key fields; the scan was corrected and `project_memory/runlogs/20260710-0105-archimate4-model-validation-view-connection-waypoint-geometry-status-focused-test.txt` passed.
- Verification: full model validation passed with 27 tests in `project_memory/runlogs/20260710-0104-archimate4-model-validation-view-connection-waypoint-geometry-full-model-test.txt`; JSON parse passed in `project_memory/runlogs/20260710-0106-archimate4-model-validation-view-connection-waypoint-geometry-json-check.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0107-archimate4-model-validation-view-connection-waypoint-geometry-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0108-archimate4-model-validation-view-connection-waypoint-geometry-diff-check.txt`.
- Audit: `npm run test:language` passed with 254 tests in `project_memory/runlogs/20260710-0109-archimate4-model-validation-view-connection-waypoint-geometry-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0110-archimate4-model-validation-view-connection-waypoint-geometry-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0111-archimate4-model-validation-view-connection-waypoint-geometry-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260710-archimate4-model-validation-view-connection-waypoint-geometry-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260710-0112-archimate4-model-validation-view-connection-waypoint-geometry-repo-lint.txt` with 4382 existing errors; changed-file ESLint remains clean.
- Final verification after state/audit updates: state update passed in `project_memory/runlogs/20260710-0113-archimate4-model-validation-view-connection-waypoint-geometry-state-update.txt`; post-state JSON parse passed in `project_memory/runlogs/20260710-0114-archimate4-model-validation-view-connection-waypoint-geometry-post-state-json-check.txt`; post-state `git diff --check` passed in `project_memory/runlogs/20260710-0115-archimate4-model-validation-view-connection-waypoint-geometry-post-state-diff-check.txt`; final `npm run test:language` passed with 254 tests in `project_memory/runlogs/20260710-0116-archimate4-model-validation-view-connection-waypoint-geometry-final-test-language.txt`.
- Final guard after runlog/report updates: runlog trimming passed in `project_memory/runlogs/20260710-0117-archimate4-model-validation-view-connection-waypoint-geometry-trim-runlogs.txt`; JSON parse passed in `project_memory/runlogs/20260710-0118-archimate4-model-validation-view-connection-waypoint-geometry-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0119-archimate4-model-validation-view-connection-waypoint-geometry-final-diff-check.txt`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 208

- Goal: add another official-source-derived ArchiMate diagram validation guard by checking ViewElement style/font/color values.
- Observation: `project_memory/runlogs/20260710-0122-official-diagram-style-source-check.json` records public Open Group ArchiMate 3.1 Diagram XSD constraints for `StyleType`, `FontType`, and `RGBColorType`; `project_memory/runlogs/20260710-0123-c260-color-notation-source-check.json` records sanitized C260 page/heading evidence for color and notational-cue coverage.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report invalid present ViewElement style objects, lineWidth, textAlign, fillColor, lineColor, font name/size/style, font color, RGB channels, and alpha values.
- Compatibility decision: missing `style` remains tolerated for partial editor/import states; when a color object is present, RGB channels are required and range-checked, matching the public Diagram XSD and local ArchiMate 4 descriptor surface.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now includes `view-style-structure`; the refreshed completion scan is `project_memory/runlogs/20260710-0127-status-completion-api-scan.json`.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, `docs/superpowers/plans/2026-07-08-archimate-4-support.md`, and audit registry now describe view style/font/color validation and point at current evidence.
- Verification: red test failed before implementation in `project_memory/runlogs/20260710-0124-archimate4-model-validation-view-style-red-test.txt`; focused tests passed in `project_memory/runlogs/20260710-0126-archimate4-model-validation-view-style-focused-test.txt` and `project_memory/runlogs/20260710-0129-archimate4-model-validation-view-style-status-focused-test.txt`.
- Verification: full model validation passed with 28 tests in `project_memory/runlogs/20260710-0128-archimate4-model-validation-view-style-full-model-test.txt`; JSON parse passed in `project_memory/runlogs/20260710-0130-archimate4-model-validation-view-style-json-check.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0131-archimate4-model-validation-view-style-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0132-archimate4-model-validation-view-style-diff-check.txt`.
- Audit: `npm run test:language` passed with 255 tests in `project_memory/runlogs/20260710-0133-archimate4-model-validation-view-style-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0134-archimate4-model-validation-view-style-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0135-archimate4-model-validation-view-style-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260710-archimate4-model-validation-view-style-audit.md`.
- Known lint status: repo-wide `npm run lint` remains the expected legacy failure, recorded in `project_memory/runlogs/20260710-0136-archimate4-model-validation-view-style-repo-lint.txt` with 4382 existing errors; changed-file ESLint remains clean.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.
- Final guard after strict font-size alignment: focused style test, full model validation, changed-file ESLint, diff check, and final `npm run test:language` passed; final language-test evidence is `project_memory/runlogs/20260710-0140-archimate4-model-validation-view-style-final-test-language.txt`.

## 2026-07-10 loop 209

- Goal: tighten official Diagram XSD-derived font style validation by rejecting `font.style` lists that combine `plain` with styling tokens.
- Observation: `project_memory/runlogs/20260710-0144-official-diagram-font-style-source-check.json` records the public Open Group ArchiMate 3.1 Diagram XSD `FontStyleEnum` / `FontStyleType` values and the `plain` no-styling documentation evidence.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-view-style-font-plain-combination` when `plain` is combined with `bold`, `italic`, or `underline` in a ViewElement `style.font.style` token list.
- Compatibility decision: this extends the existing `view-style-structure` model-validation check; it does not change ArchiMate 3.x defaults or make any MEFF 4.0 XSD conformance claim.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, `docs/superpowers/plans/2026-07-08-archimate-4-support.md`, and the audit registry now describe the `plain` combination guard.
- Verification: red test failed before implementation in `project_memory/runlogs/20260710-0145-archimate4-model-validation-font-style-plain-red-test.txt`; focused model test passed in `project_memory/runlogs/20260710-0146-archimate4-model-validation-font-style-plain-focused-test.txt`; full model validation passed with 28 tests in `project_memory/runlogs/20260710-0147-archimate4-model-validation-font-style-plain-full-model-test.txt`.
- Verification: changed-file ESLint passed in `project_memory/runlogs/20260710-0148-archimate4-model-validation-font-style-plain-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0149-archimate4-model-validation-font-style-plain-diff-check.txt`; `npm run test:language` passed with 255 tests in `project_memory/runlogs/20260710-0150-archimate4-model-validation-font-style-plain-test-language.txt`.
- Audit: completion audit passed with no failures in `project_memory/runlogs/20260710-0151-archimate4-model-validation-font-style-plain-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0152-archimate4-model-validation-font-style-plain-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260710-archimate4-model-validation-font-style-plain-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 210

- Goal: add a host-facing ArchiMate 4 conformance report API so official blockers and companion gaps can be displayed without reconstructing status fields manually.
- Observation: `getArchimate4ImplementationStatus()` already preserves official blocker ids, missing required sources, required-before-claim actions, remaining gaps, and W262 companion source status, but host tooling had to join those fields itself.
- Implemented: `getArchimate4ConformanceReport()` now derives a flattened report with `status`, `officialConformanceClaimable`, official blocker rows, required-before-claim actions, missing required sources, remaining gap ids, companion gaps, implemented shall count, external-blocked shall count, and status runlog path.
- Boundary: the report intentionally keeps `status: "blocked"` and `externalBoundaryRetained: true` while Appendix B, MEFF 4.0 XSD, and Appendix A artwork-rights blockers remain unresolved; W262 remains a companion gap and is not treated as an official conformance blocker.
- Documentation: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, `docs/superpowers/plans/2026-07-08-archimate-4-support.md`, and audit registry now describe the conformance report API.
- Verification: red test failed before implementation in `project_memory/runlogs/20260710-0160-archimate4-conformance-report-red-test.txt`; focused API test passed in `project_memory/runlogs/20260710-0161-archimate4-conformance-report-focused-test.txt`; report JSON snapshot and parse passed in `project_memory/runlogs/20260710-0162-archimate4-conformance-report-status-snapshot.json` and `project_memory/runlogs/20260710-0163-archimate4-conformance-report-snapshot-json-check.txt`.
- Verification: focused status/documentation test passed in `project_memory/runlogs/20260710-0164-archimate4-conformance-report-focused-status-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0165-archimate4-conformance-report-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0166-archimate4-conformance-report-diff-check.txt`; `npm run test:language` passed with 256 tests in `project_memory/runlogs/20260710-0167-archimate4-conformance-report-test-language.txt`.
- Audit: completion audit passed with no failures in `project_memory/runlogs/20260710-0168-archimate4-conformance-report-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0169-archimate4-conformance-report-c260-coverage-audit.json`; audit report is `project_memory/audit/reports/20260710-archimate4-conformance-report-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 211

- Goal: refresh the current official external-source evidence for W262 and MEFF 4.0 XSD, then align profile/docs/tests/audit state with the refreshed runlog.
- Observation: `project_memory/runlogs/20260710-0173-external-source-current-recheck.json` records a scripted check at 2026-07-10T03:35:00+09:00. The official XSD directory returned 200, listed only 3.1 Diagram/Model/View XSD links, and tested 4.0 candidates returned 404 while the 3.1 Model XSD baseline returned 200.
- Observation: the W262 publication page returned 200 and exposed title/free-PDF/login/page-count/publication-date markers; local search under Downloads and Codex attachments found no W262 or ArchiMate 4 motivation PDF candidate.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now points `sourceCoverage.w262` and `sourceCoverage.meff4Xsd` at `project_memory/runlogs/20260710-0173-external-source-current-recheck.json`; `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, `docs/superpowers/plans/2026-07-08-archimate-4-support.md`, and `test/language-profile.test.mjs` were aligned to the same current evidence.
- Audit registry: `audit.archimate4.external_source_current_recheck` now records the focused source/conformance guard and 0173-0181 evidence artifacts; `audit.archimate4.c260_coverage` now points at the current C260 coverage audit artifact.
- Verification: focused source/conformance tests passed in `project_memory/runlogs/20260710-0174-external-source-current-recheck-focused-test.txt`; JSON parse passed in `project_memory/runlogs/20260710-0175-external-source-current-recheck-json-check.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0176-external-source-current-recheck-eslint-changed.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0177-external-source-current-recheck-diff-check.txt`.
- Verification: `npm run test:language` passed with 256 tests in `project_memory/runlogs/20260710-0178-external-source-current-recheck-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0179-external-source-current-recheck-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0180-external-source-current-recheck-c260-coverage-audit.json`; conformance report snapshot is `project_memory/runlogs/20260710-0181-external-source-current-recheck-conformance-report.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0182-external-source-current-recheck-post-state-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0183-external-source-current-recheck-post-state-diff-check.txt`; focused source/conformance tests passed with 7 tests in `project_memory/runlogs/20260710-0184-external-source-current-recheck-post-state-focused-test.txt`; final `npm run test:language` passed with 256 tests in `project_memory/runlogs/20260710-0185-external-source-current-recheck-post-state-test-language.txt`; completion and C260 audits passed with no failures in `project_memory/runlogs/20260710-0186-external-source-current-recheck-post-state-completion-audit.json` and `project_memory/runlogs/20260710-0187-external-source-current-recheck-post-state-c260-coverage-audit.json`.
- Audit report: `project_memory/audit/reports/20260710-external-source-current-recheck-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 212

- Goal: expose the host-facing ArchiMate 4 conformance report in the bundled Viewer and Editor demos so official blockers are visible on screen.
- Observation: `getArchimate4ConformanceReport()` already returns official blocker ids, missing required sources, required-before-claim actions, remaining gaps, and the W262 companion gap, but the demo UI did not render those fields.
- Implemented: `demo/src/sample-canvas.js` now renders a shared conformance panel. In ArchiMate 4 mode it displays blocked/claimable state, missing required sources, missing companion sources, and required actions from `getArchimate4ConformanceReport()`. In ArchiMate 3.x mode it displays the report as not applicable.
- Implemented: `demo/viewer.html` and `demo/editor.html` now include conformance panel targets; `demo/demo.css` adds compact sidebar styling with wrapping; README, CHANGELOG, source ledger, and implementation specification record the demo boundary.
- Verification: focused demo conformance tests passed in `project_memory/runlogs/20260710-0191-demo-conformance-panel-focused-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0192-demo-conformance-panel-eslint-changed.txt`; demo build passed in `project_memory/runlogs/20260710-0193-demo-conformance-panel-demo-build.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0194-demo-conformance-panel-diff-check.txt`.
- Verification: `npm run test:language` passed with 258 tests in `project_memory/runlogs/20260710-0195-demo-conformance-panel-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0196-demo-conformance-panel-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0197-demo-conformance-panel-c260-coverage-audit.json`; final changed-file ESLint passed in `project_memory/runlogs/20260710-0198-demo-conformance-panel-final-eslint-changed.txt`.
- Browser smoke: `project_memory/runlogs/20260710-0199-demo-conformance-panel-browser-smoke.txt` verified Editor/Viewer 4.0 pages show `Blocked`, three official blockers, W262 as companion, and three required actions; Editor/Viewer 3.x pages show `Not applicable` and zero actions.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0200-demo-conformance-panel-final-json-check.txt`; final `git diff --check` passed in `project_memory/runlogs/20260710-0201-demo-conformance-panel-final-diff-check.txt`; focused demo conformance tests passed in `project_memory/runlogs/20260710-0202-demo-conformance-panel-final-focused-test.txt`; final `npm run test:language` passed with 258 tests in `project_memory/runlogs/20260710-0203-demo-conformance-panel-final-test-language.txt`.
...
- Goal: tighten ArchiMate model validation against the local descriptor's `IdObject.id` string identity field.
- Observation: `lib/moddle/resources/archimate4.json` declares `IdObject.id` as an XML id string. `PropertyDefinition.id` already had dedicated structure validation, but other present IdObject ids on models, elements, relationships, viewpoints, views, organizations, and view elements were not checked generically.
- Red test: `project_memory/runlogs/20260710-0249-id-object-id-red-test.txt` failed as expected before implementation because invalid present ids did not produce `invalid-id-object-id`.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-id-object-id` when a present IdObject `id` is not a non-empty string, while continuing to tolerate undefined or null ids as absent during partial in-memory editing.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now exposes `id-object-id` in expected/actual check ids; README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the check.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0250-id-object-id-focused-model-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0251-id-object-id-status-test.txt`; full model validation passed in `project_memory/runlogs/20260710-0252-id-object-id-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0253-id-object-id-eslint-changed.txt`.
- Verification: status snapshot parse passed in `project_memory/runlogs/20260710-0254-id-object-id-status-snapshot.json`; `npm run test:language` passed with 261 tests in `project_memory/runlogs/20260710-0255-id-object-id-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0256-id-object-id-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0257-id-object-id-c260-coverage-audit.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0258-id-object-id-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0259-id-object-id-diff-check.txt`; status snapshot saved in `project_memory/runlogs/20260710-0260-id-object-id-status.txt`; final `git diff --check` passed in `project_memory/runlogs/20260710-0261-id-object-id-final-diff-check.txt`; final post-stage `git diff --check` passed in `project_memory/runlogs/20260710-0262-id-object-id-final-poststage-diff-check.txt`.
- Audit report: `project_memory/audit/reports/20260710-id-object-id-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 217

- Goal: tighten ArchiMate model validation against the local descriptor's relationship option field types.
- Observation: `lib/moddle/resources/archimate4.json` declares `Relationship.modifier` and `Relationship.accessType` as strings and `Relationship.isDirected` as boolean. Existing validation covered multiplicity but did not check these option field types.
- Red test: `project_memory/runlogs/20260710-0263-relationship-option-fields-red-test.txt` failed as expected before implementation because non-string `modifier` / `accessType` and non-boolean `isDirected` did not produce diagnostics.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-relationship-modifier`, `invalid-relationship-access-type`, and `invalid-relationship-is-directed` when present option values do not match descriptor field types, while continuing to tolerate undefined or null values as absent during partial in-memory editing.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now exposes `relationship-option-fields` in expected/actual check ids; README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the check.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0264-relationship-option-fields-focused-model-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0265-relationship-option-fields-status-test.txt`; full model validation passed in `project_memory/runlogs/20260710-0266-relationship-option-fields-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0267-relationship-option-fields-eslint-changed.txt`.
- Verification: status snapshot parse passed in `project_memory/runlogs/20260710-0268-relationship-option-fields-status-snapshot.json`; `npm run test:language` passed with 262 tests in `project_memory/runlogs/20260710-0269-relationship-option-fields-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0270-relationship-option-fields-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0271-relationship-option-fields-c260-coverage-audit.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0272-relationship-option-fields-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0273-relationship-option-fields-diff-check.txt`; status snapshot saved in `project_memory/runlogs/20260710-0274-relationship-option-fields-status.txt`; final `git diff --check` passed in `project_memory/runlogs/20260710-0275-relationship-option-fields-final-diff-check.txt`; final post-stage `git diff --check` passed in `project_memory/runlogs/20260710-0276-relationship-option-fields-final-poststage-diff-check.txt`.
- Audit report: `project_memory/audit/reports/20260710-relationship-option-fields-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 218

- Goal: tighten ArchiMate model validation against the local descriptor's Viewpoint-related string fields.
- Observation: `lib/moddle/resources/archimate4.json` declares `View.viewpoint`, `AllowedElementType.type`, and `AllowedRelationshipType.type` as string attributes. Existing validation applied profile viewpoint content rules, but did not report non-string `View.viewpoint` values and could route non-string allowed element type values into unsupported-type diagnostics instead of descriptor-shape diagnostics.
- Red test: `project_memory/runlogs/20260710-0278-viewpoint-descriptor-fields-red-test.txt` failed as expected before implementation because non-string `View.viewpoint` remained valid and non-string allowed type entries were not consistently rejected as malformed entries.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-view-viewpoint` when a present `View.viewpoint` is not a string, while continuing to tolerate undefined or null values as absent during partial in-memory editing.
- Implemented: Viewpoint allowed element/relationship type parsing now accepts string shorthand and object entries with string `type` only; non-string values now produce `invalid-viewpoint-element-type-entry` or `invalid-viewpoint-relationship-type-entry` before active-profile support checks.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now exposes `view-viewpoint-attribute` in expected/actual check ids; README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the check.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0279-viewpoint-descriptor-fields-focused-model-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0280-viewpoint-descriptor-fields-status-test.txt`; full model validation passed in `project_memory/runlogs/20260710-0281-viewpoint-descriptor-fields-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0283-viewpoint-descriptor-fields-eslint-changed.txt`.
- Verification: status snapshot parse passed in `project_memory/runlogs/20260710-0284-viewpoint-descriptor-fields-status-snapshot.json`; `npm run test:language` passed with 264 tests in `project_memory/runlogs/20260710-0285-viewpoint-descriptor-fields-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0286-viewpoint-descriptor-fields-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0287-viewpoint-descriptor-fields-c260-coverage-audit.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0291-viewpoint-descriptor-fields-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0292-viewpoint-descriptor-fields-final-diff-check.txt`; status snapshot saved in `project_memory/runlogs/20260710-0293-viewpoint-descriptor-fields-final-status.txt`; pre-stage `git diff --check` passed in `project_memory/runlogs/20260710-0294-viewpoint-descriptor-fields-prestage-diff-check.txt`.
- Audit report: `project_memory/audit/reports/20260710-viewpoint-descriptor-fields-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 219

- Goal: tighten ArchiMate model validation against descriptor-declared `xsi:type` string fields.
- Observation: `lib/moddle/resources/archimate4.json` and the 3.x descriptors declare `Concept.xsi:type` and `ViewElement.xsi:type` as string attributes. Existing validation did not report non-string present `xsi:type` values on elements, relationships, or view elements.
- Red test: `project_memory/runlogs/20260710-0296-xsi-type-fields-red-test.txt` failed as expected before implementation because non-string `xsi:type` values did not produce diagnostics and the model remained valid.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-concept-xsi-type` for non-string present `xsi:type` values on elements and relationships, and `invalid-view-element-xsi-type` for non-string present `xsi:type` values on view elements. Undefined or null values remain absent for partial in-memory editing.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now exposes `xsi-type-fields` in expected/actual check ids; README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the check.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0297-xsi-type-fields-focused-model-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0298-xsi-type-fields-status-test.txt`; repeated focused model validation passed in `project_memory/runlogs/20260710-0299-xsi-type-fields-focused-repeat-test.txt`; full model validation passed in `project_memory/runlogs/20260710-0300-xsi-type-fields-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0302-xsi-type-fields-eslint-changed.txt`.
- Verification: status snapshot parse passed in `project_memory/runlogs/20260710-0303-xsi-type-fields-status-snapshot.json`; `npm run test:language` passed with 265 tests in `project_memory/runlogs/20260710-0304-xsi-type-fields-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0305-xsi-type-fields-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0306-xsi-type-fields-c260-coverage-audit.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0307-xsi-type-fields-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0308-xsi-type-fields-diff-check.txt`; status snapshot saved in `project_memory/runlogs/20260710-0309-xsi-type-fields-status.txt`; final `git diff --check` passed in `project_memory/runlogs/20260710-0310-xsi-type-fields-final-diff-check.txt`; final status snapshot saved in `project_memory/runlogs/20260710-0311-xsi-type-fields-final-status.txt`.
- Audit report: `project_memory/audit/reports/20260710-xsi-type-fields-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 220

- Goal: tighten ArchiMate model validation around relationship endpoint reference shape without embedding Appendix B matrix data.
- Observation: `Relationship.source` and `Relationship.target` are descriptor references to model concepts, but malformed or unknown endpoint references were previously collapsed into the generic `missing-relationship-endpoint` diagnostic.
- Red test: `project_memory/runlogs/20260710-0316-relationship-endpoint-reference-red-test.txt` failed as expected before implementation because malformed `source: {}` and unresolved `target: "missing-concept"` did not produce role-specific reference diagnostics.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-relationship-source-reference`, `invalid-relationship-target-reference`, `unknown-relationship-source-reference`, and `unknown-relationship-target-reference` for present relationship endpoint references that are malformed or unresolved. Absent endpoints and typed in-memory endpoint objects preserve the existing partial-editing behavior.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now exposes `relationship-endpoint-reference` in expected/actual check ids; README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the check.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0317-relationship-endpoint-reference-focused-model-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0318-relationship-endpoint-reference-status-test.txt`; full model validation passed in `project_memory/runlogs/20260710-0319-relationship-endpoint-reference-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0320-relationship-endpoint-reference-eslint-changed.txt`.
- Verification: status snapshot passed in `project_memory/runlogs/20260710-0321-relationship-endpoint-reference-status-snapshot.json`; `npm run test:language` passed with 266 tests in `project_memory/runlogs/20260710-0322-relationship-endpoint-reference-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0323-relationship-endpoint-reference-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0324-relationship-endpoint-reference-c260-coverage-audit.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0325-relationship-endpoint-reference-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0326-relationship-endpoint-reference-diff-check.txt`; status snapshot saved in `project_memory/runlogs/20260710-0327-relationship-endpoint-reference-status.txt`; final status API snapshot saved in `project_memory/runlogs/20260710-0328-relationship-endpoint-reference-final-status-api.json`; final `npm run test:language` passed with 266 tests in `project_memory/runlogs/20260710-0329-relationship-endpoint-reference-final-test-language.txt`; final completion and C260 coverage audits passed with no failures in `project_memory/runlogs/20260710-0330-relationship-endpoint-reference-final-completion-audit.json` and `project_memory/runlogs/20260710-0331-relationship-endpoint-reference-final-c260-coverage-audit.json`.
- Audit report: `project_memory/audit/reports/20260710-relationship-endpoint-reference-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 221

- Goal: tighten ArchiMate model validation around descriptor-backed organization tree structure.
- Observation: nested `Organization.organizations` list and entry diagnostics already existed, but a malformed root `organizationsNode` value could be silently ignored before reaching organization validation.
- Red test: `project_memory/runlogs/20260710-0335-organization-tree-structure-red-test.txt` failed as expected before implementation because `organizationsNode: "not-an-organizations-node"` remained valid.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-organizations-node` for malformed root organization containers while preserving array shorthand and object containers. Existing `invalid-organization-list`, `invalid-organization-entry`, and `identifierRef` diagnostics continue to cover nested organization content.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now exposes `organization-tree-structure` in expected/actual check ids; README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the check.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0336-organization-tree-structure-focused-model-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0337-organization-tree-structure-status-test.txt`; full model validation passed with 37 tests in `project_memory/runlogs/20260710-0338-organization-tree-structure-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0340-organization-tree-structure-eslint-changed.txt`.
- Verification: status snapshot passed in `project_memory/runlogs/20260710-0339-organization-tree-structure-status-snapshot.json`; `npm run test:language` passed with 267 tests in `project_memory/runlogs/20260710-0341-organization-tree-structure-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0342-organization-tree-structure-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0343-organization-tree-structure-c260-coverage-audit.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0344-organization-tree-structure-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0345-organization-tree-structure-diff-check.txt`; status API snapshot saved in `project_memory/runlogs/20260710-0346-organization-tree-structure-final-status-api.json`; worktree status snapshot saved in `project_memory/runlogs/20260710-0347-organization-tree-structure-status.txt`; final `npm run test:language` passed with 267 tests in `project_memory/runlogs/20260710-0348-organization-tree-structure-final-test-language.txt`; final completion and C260 coverage audits passed with no failures in `project_memory/runlogs/20260710-0349-organization-tree-structure-final-completion-audit.json` and `project_memory/runlogs/20260710-0350-organization-tree-structure-final-c260-coverage-audit.json`; final JSON parse and `git diff --check` passed in `project_memory/runlogs/20260710-0351-organization-tree-structure-final-json-check.txt` and `project_memory/runlogs/20260710-0352-organization-tree-structure-final-diff-check.txt`; final status snapshot saved in `project_memory/runlogs/20260710-0353-organization-tree-structure-final-status.txt`.
- Audit report: `project_memory/audit/reports/20260710-organization-tree-structure-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 222

- Goal: tighten ArchiMate model validation around descriptor-backed View tree structure.
- Observation: `project_memory/runlogs/20260710-0354-view-tree-structure-current-gap.txt` showed that malformed `views`, `diagrams`, and `viewsList` values were previously accepted as valid because `getModelViews()` collapsed unsupported containers into an empty list.
- Red test: `project_memory/runlogs/20260710-0355-view-tree-structure-red-test.txt` failed as expected before implementation because malformed View tree structure did not produce diagnostics.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-views-node`, `invalid-diagrams-node`, `invalid-view-list`, `invalid-view-entry`, `invalid-view-element-list`, `invalid-view-element-entry`, `invalid-view-node-list`, and `invalid-view-node-entry` for malformed present `Views`, `Diagrams`, `View`, `ViewElement`, and nested `Node.nodes` structures, while absent fields remain allowed for partial in-memory editing.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now exposes `view-tree-structure` in expected/actual check ids; README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the check.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0357-view-tree-structure-focused-model-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0358-view-tree-structure-status-test.txt`; full model validation passed with 38 tests in `project_memory/runlogs/20260710-0359-view-tree-structure-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0360-view-tree-structure-eslint-changed.txt`.
- Verification: status snapshot was recorded in `project_memory/runlogs/20260710-0361-view-tree-structure-status-snapshot.json`; `npm run test:language` passed with 268 tests in `project_memory/runlogs/20260710-0362-view-tree-structure-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0363-view-tree-structure-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0364-view-tree-structure-c260-coverage-audit.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0373-view-tree-structure-final-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0374-view-tree-structure-prestage-diff-check.txt`; final focused tests passed in `project_memory/runlogs/20260710-0370-view-tree-structure-final-focused-tests.txt`; final `npm run test:language` passed with 268 tests in `project_memory/runlogs/20260710-0372-view-tree-structure-final-test-language.txt`; final completion and C260 coverage audits passed in `project_memory/runlogs/20260710-0367-view-tree-structure-final-completion-audit.json` and `project_memory/runlogs/20260710-0368-view-tree-structure-final-c260-coverage-audit.json`.
- Audit report: `project_memory/audit/reports/20260710-view-tree-structure-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 223

- Goal: tighten ArchiMate model validation around descriptor-backed `Elements` and `Relationships` container structure.
- Observation: `project_memory/runlogs/20260710-0375-concept-container-structure-current-gap.txt` showed that malformed `elementsNode` could be treated as valid and malformed `baseElements` could throw before diagnostics were returned.
- Red test: `project_memory/runlogs/20260710-0376-concept-container-structure-red-test.txt` failed as expected before implementation because malformed concept containers did not produce structure diagnostics and one malformed list path raised a `TypeError`.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-elements-node`, `invalid-element-list`, `invalid-element-entry`, `invalid-relationships-node`, `invalid-relationship-list`, and `invalid-relationship-entry` for malformed present `Elements` / `Relationships` container, list, and entry structure while preserving absent fields for partial in-memory editing.
- Implemented: `getModelElements()` and `getModelRelationships()` now defensively return only object entries after structure diagnostics are emitted, preventing malformed concept lists from crashing later validation passes.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now exposes `concept-container-structure`; README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the check.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0377-concept-container-structure-focused-model-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0378-concept-container-structure-status-test.txt`; full model validation passed with 39 tests in `project_memory/runlogs/20260710-0379-concept-container-structure-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0380-concept-container-structure-eslint-changed.txt`.
- Verification: status snapshot passed in `project_memory/runlogs/20260710-0381-concept-container-structure-status-snapshot.json`; `npm run test:language` passed with 269 tests in `project_memory/runlogs/20260710-0382-concept-container-structure-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0383-concept-container-structure-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0384-concept-container-structure-c260-coverage-audit.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0385-concept-container-structure-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0386-concept-container-structure-diff-check.txt`; final focused tests passed in `project_memory/runlogs/20260710-0387-concept-container-structure-final-focused-tests.txt`; final `npm run test:language` passed with 269 tests in `project_memory/runlogs/20260710-0388-concept-container-structure-final-test-language.txt`; final completion and C260 coverage audits passed with no failures in `project_memory/runlogs/20260710-0389-concept-container-structure-final-completion-audit.json` and `project_memory/runlogs/20260710-0390-concept-container-structure-final-c260-coverage-audit.json`; post-state JSON parse and `git diff --check` passed in `project_memory/runlogs/20260710-0391-concept-container-structure-final-json-check.txt` and `project_memory/runlogs/20260710-0392-concept-container-structure-final-diff-check.txt`.
- Audit report: `project_memory/audit/reports/20260710-concept-container-structure-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 224

- Goal: tighten ArchiMate model validation around descriptor-backed `PropertyDefinitions` and `Properties` root container structure.
- Observation: `project_memory/runlogs/20260710-0396-property-container-structure-current-gap.txt` showed that malformed `propertyDefinitionsNode` and `propertiesNode` root values were reported only as child-list diagnostics, making root container errors indistinguishable from list errors.
- Red test: `project_memory/runlogs/20260710-0397-property-container-structure-red-test.txt` failed as expected before implementation because `invalid-property-definitions-node` and `invalid-properties-node` were not produced.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-property-definitions-node` for malformed `PropertyDefinitions` root containers and `invalid-properties-node` for malformed per-owner `Properties` root containers, while preserving `invalid-property-definition-list` and `invalid-properties-list` for malformed child lists.
- Implemented: array shorthand for `propertyDefinitionsNode` remains accepted for existing in-memory helper compatibility, and `getArchimate4ImplementationStatus().modelValidation` now exposes `property-container-structure`.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0398-property-container-structure-focused-model-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0399-property-container-structure-status-test.txt`; full model validation passed with 40 tests in `project_memory/runlogs/20260710-0400-property-container-structure-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0401-property-container-structure-eslint-changed.txt`.
- Verification: status snapshot passed in `project_memory/runlogs/20260710-0402-property-container-structure-status-snapshot.json`; `npm run test:language` passed with 270 tests in `project_memory/runlogs/20260710-0403-property-container-structure-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0404-property-container-structure-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0405-property-container-structure-c260-coverage-audit.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0406-property-container-structure-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0407-property-container-structure-diff-check.txt`; final `npm run test:language` passed with 270 tests in `project_memory/runlogs/20260710-0408-property-container-structure-final-test-language.txt`; final completion and C260 coverage audits passed with no failures in `project_memory/runlogs/20260710-0409-property-container-structure-final-completion-audit.json` and `project_memory/runlogs/20260710-0410-property-container-structure-final-c260-coverage-audit.json`; precommit JSON parse and `git diff --check` passed in `project_memory/runlogs/20260710-0411-property-container-structure-precommit-json-check.txt` and `project_memory/runlogs/20260710-0412-property-container-structure-precommit-diff-check.txt`.
- Audit report: `project_memory/audit/reports/20260710-property-container-structure-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 225

- Goal: tighten ArchiMate model validation around descriptor-backed `Viewpoints` container structure.
- Observation: `project_memory/runlogs/20260710-0415-viewpoint-container-structure-current-gap.txt` showed malformed `views.viewpointsNode` and shorthand `views.viewpoints` values could be accepted without diagnostics, and malformed `viewpointsNode.viewpoints` could throw before diagnostics were returned.
- Red test: `project_memory/runlogs/20260710-0416-viewpoint-container-structure-red-test.txt` failed as expected before implementation because malformed `Viewpoints` container data did not produce structure diagnostics and one malformed list path raised a `TypeError`.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-viewpoints-node`, `invalid-viewpoint-list`, and `invalid-viewpoint-entry` for malformed descriptor-backed `Viewpoints` root containers, child lists, and entries while preserving absent fields for partial in-memory editing.
- Implemented: `getModelViewpoints()` now filters malformed entries after structure diagnostics are emitted, and `getArchimate4ImplementationStatus().modelValidation` now exposes `viewpoint-container-structure`.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0417-viewpoint-container-structure-focused-model-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0418-viewpoint-container-structure-status-test.txt`; full model validation passed with 41 tests in `project_memory/runlogs/20260710-0419-viewpoint-container-structure-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0420-viewpoint-container-structure-eslint-changed.txt`.
- Verification: status snapshot passed in `project_memory/runlogs/20260710-0421-viewpoint-container-structure-status-snapshot.json`; `npm run test:language` passed with 271 tests in `project_memory/runlogs/20260710-0422-viewpoint-container-structure-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0423-viewpoint-container-structure-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0424-viewpoint-container-structure-c260-coverage-audit.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0430-viewpoint-container-structure-precommit-json-check.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0431-viewpoint-container-structure-precommit-diff-check.txt`; final `npm run test:language` passed with 271 tests in `project_memory/runlogs/20260710-0427-viewpoint-container-structure-final-test-language.txt`; final completion and C260 coverage audits passed with no failures in `project_memory/runlogs/20260710-0428-viewpoint-container-structure-final-completion-audit.json` and `project_memory/runlogs/20260710-0429-viewpoint-container-structure-final-c260-coverage-audit.json`.
- Audit report: `project_memory/audit/reports/20260710-viewpoint-container-structure-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 226

- Goal: tighten ArchiMate model validation around `Viewpoint.viewpointPurpose` and `Viewpoint.viewpointContent` token-field structure.
- Observation: `project_memory/runlogs/20260710-0434-viewpoint-token-field-structure-current-gap.txt` showed malformed purpose/content values were either accepted without diagnostics or coerced into synthetic unsupported token fragments.
- Red test: `project_memory/runlogs/20260710-0435-viewpoint-token-field-structure-red-test.txt` failed as expected before implementation because `invalid-viewpoint-purpose-entry` and `invalid-viewpoint-content-entry` were not produced.
- Implemented: `validateArchimate4Model()` and `validateArchimateModel()` now report `invalid-viewpoint-purpose-entry` and `invalid-viewpoint-content-entry` for malformed purpose/content scalar values and list entries before supported-token checks run. String token fields and existing string-array helper compatibility remain accepted.
- Implemented: `getArchimate4ImplementationStatus().modelValidation` now exposes `viewpoint-token-field-structure`; README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the check.
- Verification: focused model validation passed in `project_memory/runlogs/20260710-0436-viewpoint-token-field-structure-focused-model-test.txt`; repeated focused model validation passed in `project_memory/runlogs/20260710-0438-viewpoint-token-field-structure-focused-repeat-test.txt`; focused status test passed in `project_memory/runlogs/20260710-0439-viewpoint-token-field-structure-status-test.txt`; full model validation passed with 42 tests in `project_memory/runlogs/20260710-0440-viewpoint-token-field-structure-model-validation-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0441-viewpoint-token-field-structure-eslint-changed.txt`; status snapshot passed in `project_memory/runlogs/20260710-0442-viewpoint-token-field-structure-status-snapshot.json`.
- Post-state verification: JSON parse passed in `project_memory/runlogs/20260710-0443-viewpoint-token-field-structure-json-check.txt`; `npm run test:language` passed with 272 tests in `project_memory/runlogs/20260710-0444-viewpoint-token-field-structure-test-language.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0445-viewpoint-token-field-structure-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0446-viewpoint-token-field-structure-c260-coverage-audit.json`; `git diff --check` passed in `project_memory/runlogs/20260710-0447-viewpoint-token-field-structure-diff-check.txt`.
- Audit report: `project_memory/audit/reports/20260710-viewpoint-token-field-structure-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 227

- Goal: refresh ArchiMate 4 implementation-status completion scan evidence and make it reproducible from the status API.
- Observation: `getArchimate4ImplementationStatus().implementationCompletion.sourceRunlogPath`, README, sources, official-specification notes, and the execution plan still pointed at `project_memory/runlogs/20260710-0127-status-completion-api-scan.json` after later model-validation coverage work.
- Red test: `project_memory/runlogs/20260710-0450-status-completion-scan-refresh-red-test.txt` failed as expected because `project_memory/runlogs/20260710-0450-status-completion-api-scan.json` was absent and `scripts/write_archimate4_status_completion_scan.mjs` did not exist.
- Implemented: `getArchimate4ImplementationStatus()` now accepts `implementationCompletionRunlogPath` for reproducible status scan generation, the default completion scan path points at `project_memory/runlogs/20260710-0450-status-completion-api-scan.json`, and `scripts/write_archimate4_status_completion_scan.mjs` writes the scan from the current status API.
- Implemented: README, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, and the ArchiMate 4 execution plan now reference the refreshed scan evidence and document the generator.
- Verification: focused status completion scan tests passed in `project_memory/runlogs/20260710-0451-status-completion-scan-refresh-focused-test.txt`; completion audit passed with no failures in `project_memory/runlogs/20260710-0452-status-completion-scan-refresh-completion-audit.json`; C260 coverage audit passed with no failures in `project_memory/runlogs/20260710-0453-status-completion-scan-refresh-c260-coverage-audit.json`.
- Verification: changed-file ESLint passed in `project_memory/runlogs/20260710-0454-status-completion-scan-refresh-eslint-changed.txt`; `npm run test:language` passed with 273 tests in `project_memory/runlogs/20260710-0455-status-completion-scan-refresh-test-language.txt`; status snapshot saved in `project_memory/runlogs/20260710-0456-status-completion-scan-refresh-status-snapshot.json`; final JSON parse and `git diff --check` passed in `project_memory/runlogs/20260710-0457-status-completion-scan-refresh-json-check.txt` and `project_memory/runlogs/20260710-0458-status-completion-scan-refresh-diff-check.txt`.
- Audit report: `project_memory/audit/reports/20260710-status-completion-scan-refresh-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data, W262 PDF local availability, and MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 228

- Goal: add a safe official-specification-facing Appendix B relationship-profile intake path to the Editor demo without embedding the normative Appendix B relationship matrix.
- Observation: the runtime already had `setArchimate4RelationshipProfile()`, complete source/target-cell validation, source metadata, and coverage reports, but the bundled Editor demo only showed the conformance report and had no UI for host-supplied licensed Appendix B profile data.
- Red test: `project_memory/runlogs/20260710-0459-demo-relationship-profile-red-test.txt` failed as expected because `demo/editor.html`, `demo/src/editor.js`, and `demo/src/sample-canvas.js` had no relationship-profile input panel or renderer.
- Implemented: `demo/editor.html` now contains an Appendix B Profile panel with profile input, load/reset buttons, and source/cell/missing-count fields. `demo/src/editor.js` loads JSON, CSV, or TSV matrix text through `setArchimate4RelationshipProfile()` with `requireComplete` and `requireCompleteTargets` enabled. `demo/src/sample-canvas.js` renders active relationship-profile source and coverage separately from the official conformance panel, and 3.x mode disables the controls.
- Implemented: README, CHANGELOG, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, the execution plan, audit registry, and state now document the Appendix B demo intake boundary while preserving the external Appendix B blocker.
- Verification: focused demo relationship-profile test passed in `project_memory/runlogs/20260710-0460-demo-relationship-profile-focused-test.txt`; combined demo tests passed in `project_memory/runlogs/20260710-0463-demo-relationship-profile-focused-tests.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0465-demo-relationship-profile-eslint-changed.txt`; registry-scoped ESLint passed in `project_memory/runlogs/20260710-0473-demo-relationship-profile-eslint-registry.txt`.
- Verification: demo build passed in `project_memory/runlogs/20260710-0466-demo-relationship-profile-final-demo-build.txt`; browser smoke passed in `project_memory/runlogs/20260710-0467-demo-relationship-profile-final-browser-smoke.txt`, confirming ArchiMate 4 loads a complete 3025-cell external profile and ArchiMate 3.x disables the controls.
- Verification: `npm run test:language` passed with 274 tests in `project_memory/runlogs/20260710-0468-demo-relationship-profile-test-language.txt`; completion and C260 coverage audits passed with no failures in `project_memory/runlogs/20260710-0469-demo-relationship-profile-completion-audit.json` and `project_memory/runlogs/20260710-0470-demo-relationship-profile-c260-coverage-audit.json`.
- Post-state verification: JSON parse and `git diff --check` passed in `project_memory/runlogs/20260710-0474-demo-relationship-profile-final-json-check.txt` and `project_memory/runlogs/20260710-0475-demo-relationship-profile-final-diff-check.txt`; pre-stage repeats passed in `project_memory/runlogs/20260710-0476-demo-relationship-profile-prestage-json-check.txt` and `project_memory/runlogs/20260710-0477-demo-relationship-profile-prestage-diff-check.txt`.
- Audit report: `project_memory/audit/reports/20260710-demo-relationship-profile-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data or redistribution approval, W262 PDF local availability, and official MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 229

- Goal: expose the official Appendix C example viewpoint catalog in the bundled Viewer and Editor demos without bundling normative viewpoint definitions.
- Observation: `getArchimate4ExampleViewpointCatalog()` already exposed an informative-reference catalog with four groups and 25 viewpoints, but the demos only displayed conformance and Appendix B profile status.
- Red test: `project_memory/runlogs/20260710-0478-demo-example-viewpoint-catalog-red-test.txt` failed as expected because `demo/viewer.html`, `demo/editor.html`, and `demo/src/sample-canvas.js` had no example viewpoint panel or renderer.
- Implemented: Viewer and Editor sidebars now include an Example Viewpoints panel. `demo/src/sample-canvas.js` renders `Informative`, `4 groups`, and `25 viewpoints` in ArchiMate 4 mode and marks the panel not applicable in ArchiMate 3.x mode. The panel lists Appendix C headings only and does not bundle full viewpoint definitions, allowed-type filters, or normative relationship constraints.
- Implemented: README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the demo exposure and its informative-only boundary.
- Verification: focused Appendix C demo test passed in `project_memory/runlogs/20260710-0479-demo-example-viewpoint-catalog-focused-test.txt`; combined demo tests passed in `project_memory/runlogs/20260710-0480-demo-example-viewpoint-focused-tests.txt`; demo build passed in `project_memory/runlogs/20260710-0481-demo-example-viewpoint-demo-build.txt`.
- Verification: browser smoke passed in `project_memory/runlogs/20260710-0482-demo-example-viewpoint-browser-smoke.json`, confirming 4.0 Viewer/Editor show `Informative`, `4 groups`, `25 viewpoints`, and 3.x Viewer/Editor show `Not applicable`.
- Verification: changed-file ESLint passed in `project_memory/runlogs/20260710-0483-demo-example-viewpoint-eslint-changed.txt`; `npm run test:language` passed with 276 tests in `project_memory/runlogs/20260710-0484-demo-example-viewpoint-test-language.txt`; completion and C260 coverage audits passed with no failures in `project_memory/runlogs/20260710-0485-demo-example-viewpoint-completion-audit.json` and `project_memory/runlogs/20260710-0486-demo-example-viewpoint-c260-coverage-audit.json`; registry-scoped ESLint passed in `project_memory/runlogs/20260710-0487-demo-example-viewpoint-eslint-registry.txt`.
- Post-state verification: JSON parse and `git diff --check` passed in `project_memory/runlogs/20260710-0488-demo-example-viewpoint-json-check.txt` and `project_memory/runlogs/20260710-0489-demo-example-viewpoint-diff-check.txt`; final focused demo tests passed in `project_memory/runlogs/20260710-0490-demo-example-viewpoint-final-focused-tests.txt`; final `npm run test:language` passed with 276 tests in `project_memory/runlogs/20260710-0491-demo-example-viewpoint-final-test-language.txt`; final completion and C260 coverage audits passed in `project_memory/runlogs/20260710-0492-demo-example-viewpoint-final-completion-audit.json` and `project_memory/runlogs/20260710-0493-demo-example-viewpoint-final-c260-coverage-audit.json`.
- Audit report: `project_memory/audit/reports/20260710-demo-example-viewpoint-catalog-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data or redistribution approval, W262 PDF local availability, and official MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 230

- Goal: expose the ArchiMate 4 model-defined Viewpoint mechanism in the bundled Viewer and Editor demos through a live validation result.
- Observation: `validateArchimate4Model()` already validates Viewpoint purpose/content, concern/stakeholder structure, and allowed element/relationship type application, but the demos only showed the Appendix C informative catalog and did not show a model-defined Viewpoint diagnostic result.
- Red test: `project_memory/runlogs/20260710-0496-demo-viewpoint-validation-red-test.txt` failed as expected because the demos and shared sample renderer had no Viewpoint Validation panel or renderer.
- Implemented: Viewer and Editor sidebars now include a Viewpoint Validation panel. In ArchiMate 4 mode, `demo/src/sample-canvas.js` builds a small model with a model-defined `Demo Viewpoint`, purpose `Deciding`, content `Overview`, concern/stakeholder metadata, allowed element types `Role` / `Service`, and allowed relationship type `Serving`, then renders the `validateArchimate4Model()` diagnostic result. In ArchiMate 3.x mode the panel is marked not applicable.
- Implemented: README, CHANGELOG, source ledger, implementation specification, execution plan, audit registry, and state now document the Viewpoint validation demo surface.
- Verification: focused Viewpoint validation panel test passed in `project_memory/runlogs/20260710-0497-demo-viewpoint-validation-focused-test.txt`; combined demo tests passed in `project_memory/runlogs/20260710-0498-demo-viewpoint-validation-focused-tests.txt`; demo build passed in `project_memory/runlogs/20260710-0499-demo-viewpoint-validation-demo-build.txt`.
- Verification: browser smoke passed in `project_memory/runlogs/20260710-0500-demo-viewpoint-validation-browser-smoke.json`, confirming 4.0 Viewer/Editor show `Valid`, `Demo Viewpoint`, `2 elements, 1 relationship`, and `0 errors`, while 3.x Viewer/Editor show `Not applicable`.
- Verification: changed-file ESLint passed in `project_memory/runlogs/20260710-0501-demo-viewpoint-validation-eslint-changed.txt`; `npm run test:language` passed with 277 tests in `project_memory/runlogs/20260710-0502-demo-viewpoint-validation-test-language.txt`; completion and C260 coverage audits passed with no failures in `project_memory/runlogs/20260710-0503-demo-viewpoint-validation-completion-audit.json` and `project_memory/runlogs/20260710-0504-demo-viewpoint-validation-c260-coverage-audit.json`.
- Post-state verification: JSON parse and `git diff --check` passed in `project_memory/runlogs/20260710-0505-demo-viewpoint-validation-json-check.txt` and `project_memory/runlogs/20260710-0506-demo-viewpoint-validation-diff-check.txt`; registry-scoped ESLint passed in `project_memory/runlogs/20260710-0507-demo-viewpoint-validation-eslint-registry.txt`.
- Final verification: focused demo tests passed with 6 tests in `project_memory/runlogs/20260710-0508-demo-viewpoint-validation-final-focused-tests.txt`; final `npm run test:language` passed with 277 tests in `project_memory/runlogs/20260710-0509-demo-viewpoint-validation-final-test-language.txt`; final completion and C260 coverage audits passed in `project_memory/runlogs/20260710-0510-demo-viewpoint-validation-final-completion-audit.json` and `project_memory/runlogs/20260710-0511-demo-viewpoint-validation-final-c260-coverage-audit.json`.
- Final pre-stage checks: JSON parse and `git diff --check` are recorded in `project_memory/runlogs/20260710-0512-demo-viewpoint-validation-final-json-check.txt` and `project_memory/runlogs/20260710-0513-demo-viewpoint-validation-final-diff-check.txt`.
- Audit report: `project_memory/audit/reports/20260710-demo-viewpoint-validation-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data or redistribution approval, W262 PDF local availability, and official MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 231

- Goal: refresh current official external-source evidence for MEFF 4.0 XSD and W262 while continuing the ArchiMate 4 completion goal.
- Observation: `project_memory/runlogs/20260710-0514-continuation-status-summary.json` showed the implementation status complete at M0-M5 but still blocked for official conformance by Appendix B relationship matrix redistribution, MEFF 4.0 XSD, exact Appendix A artwork rights, and the W262 companion-source gap.
- External source recheck: `project_memory/runlogs/20260710-0515-external-source-current-recheck.json` records the official XSD directory returning 200, listing only 3.1 Diagram/Model/View XSD links, tested 4.0 candidate URLs returning 404, and the 3.1 Model XSD baseline returning 200. The same run detected W262 publication metadata and found no local W262 PDF candidate under Downloads or Codex attachments.
- Implemented: `lib/metamodel/languages/archimate4-profile.json` now points `sourceCoverage.w262` and `sourceCoverage.meff4Xsd` at `project_memory/runlogs/20260710-0515-external-source-current-recheck.json`; `test/language-profile.test.mjs`, `docs/archimate4/sources.md`, `docs/archimate4/official-specification.md`, the execution plan, audit registry, and state are aligned to the refreshed evidence.
- Verification: focused source/status tests passed with 7 tests in `project_memory/runlogs/20260710-0516-external-source-0515-focused-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0517-external-source-0515-eslint-changed.txt`; `npm run test:language` passed with 277 tests in `project_memory/runlogs/20260710-0518-external-source-0515-test-language.txt`.
- Verification: completion and C260 coverage audits passed with no failures in `project_memory/runlogs/20260710-0519-external-source-0515-completion-audit.json` and `project_memory/runlogs/20260710-0520-external-source-0515-c260-coverage-audit.json`; conformance report snapshot is `project_memory/runlogs/20260710-0521-external-source-0515-conformance-report.json`.
- Final verification: JSON parse and `git diff --check` passed in `project_memory/runlogs/20260710-0522-external-source-0515-json-check.txt` and `project_memory/runlogs/20260710-0523-external-source-0515-diff-check.txt`; final completion and C260 coverage audits passed in `project_memory/runlogs/20260710-0524-external-source-0515-final-completion-audit.json` and `project_memory/runlogs/20260710-0525-external-source-0515-final-c260-coverage-audit.json`.
- Pre-stage verification: JSON parse and `git diff --check` passed in `project_memory/runlogs/20260710-0526-external-source-0515-prestage-json-check.txt` and `project_memory/runlogs/20260710-0527-external-source-0515-prestage-diff-check.txt`.
- Audit report: `project_memory/audit/reports/20260710-external-source-0515-recheck-audit.md`.
- Remaining open issues: exact C260 Appendix A vector artwork redistribution, official Appendix B relationship matrix data or redistribution approval, W262 PDF local availability, and official MEFF 4.0 XSD remain external-source dependent.

## 2026-07-10 loop 232

- Goal: ingest the local W262 companion paper into implementation coverage and advance Appendix B relationship-matrix intake within the recorded personal-use and source-processing boundaries.
- Source evidence: `project_memory/runlogs/20260710-0602-w262-local-source-and-appendix-b-authorization.json` records the 22-page W262 metadata and SHA-256 plus the Appendix B personal-use boundary; `project_memory/runlogs/20260710-0604-external-source-current-recheck.json` refreshes official W262 and MEFF evidence; `project_memory/runlogs/20260710-0607-w262-change-topic-coverage.json` maps 11 non-verbatim W262 topics to pages; `project_memory/runlogs/20260710-0613-appendix-b-machine-readable-source-search.json` records the scoped official/local machine-readable artifact search.
- Red tests: W262 coverage and migration expectations failed before implementation in `project_memory/runlogs/20260710-0608-w262-coverage-migration-red-test.txt`; Appendix B template exports failed before implementation in `project_memory/runlogs/20260710-0610-appendix-b-template-red-test.txt`; source-boundary metadata expectations failed before implementation in `project_memory/runlogs/20260710-0614-appendix-b-source-status-red-test.txt`.
- Implemented: `getArchimate4ImplementationStatus().w262ChangeCoverage` exposes all 11 reviewed topics with page evidence, implementation classification, status-key references, and complete coverage. W262 is now a reviewed local companion source and no longer appears in missing companion sources or remaining gaps.
- Implemented: `Representation` migration now defaults to `BusinessObject` with `DataObject`, `Artifact`, and `Material` alternatives. Cross-domain `Realization` migration warnings now cover merged `Process`, `Function`, `Service`, and `Event` concepts.
- Implemented: `npm run archimate4:relationship-template` generates a complete blank 55-by-55 TSV or CSV matrix. `setArchimate4RelationshipProfile()` rejects all-empty complete profiles before mutating the active fallback and reports the `requireRelationships` option in status.
- Boundary: personal-use authorization, redistribution need, source-processing permission, and complete machine-readable Appendix B profile availability are tracked independently. No W262 prose or Appendix B relationship values were committed, and the compatibility fallback remains active until complete approved values are loaded.
- Verification: focused W262/Appendix B tests passed with 7 tests in `project_memory/runlogs/20260710-0617-w262-appendix-b-focused-test.txt`; status completion tests passed with 2 tests in `project_memory/runlogs/20260710-0618-status-completion-focused-test.txt`; changed-file ESLint passed in `project_memory/runlogs/20260710-0619-w262-appendix-b-eslint-changed.txt`.
- Verification: `npm run test:language` passed with 282 tests in `project_memory/runlogs/20260710-0620-w262-appendix-b-test-language.txt`; demo build passed in `project_memory/runlogs/20260710-0621-w262-appendix-b-demo-build.txt`; Editor HTTP smoke returned 200 with the Appendix B panel present in `project_memory/runlogs/20260710-0625-w262-appendix-b-editor-http-smoke.json`.
- Verification: completion and C260 coverage audits passed with no failures in `project_memory/runlogs/20260710-0622-w262-appendix-b-completion-audit.json` and `project_memory/runlogs/20260710-0623-w262-appendix-b-c260-coverage-audit.json`. The refreshed completion scan in `project_memory/runlogs/20260710-0616-status-completion-api-scan.json` records 50 top-level keys, 41 complete summaries, and no incomplete summaries.
- Legacy baseline: repository-wide ESLint still fails with 4382 pre-existing errors in `project_memory/runlogs/20260710-0624-w262-appendix-b-repo-lint.txt`; the changed-file ESLint gate passes.
- Final pre-commit verification: JSON parsing, `git diff --check`, and the 282-test language suite repeat are recorded in `project_memory/runlogs/20260710-0626-w262-appendix-b-json-check.txt`, `project_memory/runlogs/20260710-0627-w262-appendix-b-diff-check.txt`, and `project_memory/runlogs/20260710-0628-w262-appendix-b-final-test-language.txt`.
- Audit report: `project_memory/audit/reports/20260710-w262-appendix-b-ingestion-audit.md`.
- Remaining open issues: complete approved machine-readable Appendix B relationship values, official MEFF 4.0 XSD, and exact Appendix A vector artwork rights remain external-source dependent.

## 2026-07-10 loop 233

- Goal: remove the repository-wide ESLint legacy baseline by applying `eslint --fix` and repairing the remaining program-level lint failures.
- Observation: `project_memory/runlogs/20260710-0700-repo-eslint-fix.txt` reduced the repository-wide lint failure from the recorded 4382-error baseline to 53 remaining errors, all in `no-undef` or `no-unused-vars`.
- Implemented: removed unused imports, variables, and dead BPMN-derived helper paths that were not on the active ArchiMate execution path; imported missing ArchiMate constants for canvas creation and label behavior; declared `oldViewElement` in shape replacement ID preservation; restored `LabelUtil`'s logger import; corrected `UpdatePropertiesHandler` to read `element.businessObject`.
- Audit registry: `audit.lint.repo_legacy` is replaced by `audit.lint.repo_clean`, with `npm run lint` expected to exit 0 and evidence in `project_memory/runlogs/20260710-0702-repo-eslint-after-manual-pass2.txt` and `project_memory/runlogs/20260710-0706-eslint-fix-npm-all.txt`.
- Verification: repository-wide ESLint passed in `project_memory/runlogs/20260710-0702-repo-eslint-after-manual-pass2.txt`; `npm run test:language` passed with 282 tests in `project_memory/runlogs/20260710-0703-eslint-fix-test-language.txt`; demo build passed in `project_memory/runlogs/20260710-0704-eslint-fix-demo-build.txt`; `git diff --check` passed in `project_memory/runlogs/20260710-0705-eslint-fix-diff-check.txt`.
- Final verification: `npm run all` passed in `project_memory/runlogs/20260710-0706-eslint-fix-npm-all.txt`; completion and C260 coverage audits passed in `project_memory/runlogs/20260710-0707-eslint-fix-completion-audit.json` and `project_memory/runlogs/20260710-0708-eslint-fix-c260-coverage-audit.json`; post-log JSON parse and diff checks passed in `project_memory/runlogs/20260710-0709-eslint-cleanup-json-check.txt` and `project_memory/runlogs/20260710-0710-eslint-cleanup-diff-check.txt`; final `npm run all` passed in `project_memory/runlogs/20260710-0711-eslint-cleanup-final-npm-all.txt`.
- Audit report: `project_memory/audit/reports/20260710-repo-wide-eslint-cleanup-audit.md`.
