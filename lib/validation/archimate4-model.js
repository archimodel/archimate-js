...
export function validateArchimateModel(model, options = {}) {
  ...
  validateViewpointContentApplication(views, viewpointIndex, elementIndex, relationshipIndex, profile, diagnostics);
...
function validateViewpointContentApplication(views, viewpointIndex, elementIndex, relationshipIndex, profile, diagnostics) {
  views.forEach(function(view) {
    var viewpoint = getViewpointForView(view, viewpointIndex);
...
function getViewpointForView(view, viewpointIndex) {
