...
* `deriveRelationship()` and `deriveRelationshipType()` expose C260-derived DR1 specialization transitivity and DR2 weakest-structural derivation for host tooling.
