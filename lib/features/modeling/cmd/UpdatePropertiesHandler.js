...
UpdatePropertiesHandler.prototype.execute = function(context) {
  ...
  var viewElement = element.businesObject,
    elementRef = viewElement.elementRef,
    ...
    oldViewElementProperties = context.oldProperties || getProperties(elementRef, properties);

  logger.log('unwrapElementRef properties');
