...
function getModelPropertyDefinitions(model) {
  var propertyDefinitionsNode = model && (model.propertyDefinitionsNode || model.propertyDefinitions);

  if (Array.isArray(propertyDefinitionsNode)) {
    return propertyDefinitionsNode;
  }

  return propertyDefinitionsNode && propertyDefinitionsNode.propertyDefinitions || [];
}
